    ...
    return (
      s.each(function() {
        var s,
          ...
          b,
          v = e.isPlainObject(r)
            ? e.extend(!0, {}, e.fn.api.settings, r)
        ...
        (b = {
          ...
          instantiate: function() {
            b.verbose('Storing instance of module', b), (w = b), k.data(A, w);
          },
          destroy: function() {
            ...
            events: function() {
              ...
              e
                ? (b.verbose('Attaching API events to element', e),
                  k.on(e + S, b.event.trigger))
                : 'now' == v.on &&
                  (b.debug('Querying API endpoint immediately'), b.query());
            }
          },
          decode: {
            json: function(e) {
          ...
          write: {
            cachedResponse: function(r, o) {
              return o && '' === o
                ? void b.debug('Response empty, not caching', o)
                : t.Storage === n
                  ? void b.error(R.noStorage)
          ...
          query: function() {
            ...
            return (
              v.defaultData && e.extend(!0, v.urlData, b.get.defaultData()),
              v.serializeForm && (v.data = b.add.formData(v.data)),
              (g = b.get.settings()),
              g === !1
                ? ((b.cancelled = !0), void b.error(R.beforeSend))
                : ((b.cancelled = !1),
                    ...
                    ? ((f = b.add.urlData(f)),
                      f || b.is.mocked()
                        ? ((g.url = v.base + f),
                          ...
                          'local' === v.cache && b.read.cachedResponse(f)
                            ? (b.debug('Response returned from local cache'),
                              (b.request = b.create.request()),
                              void b.request.resolveWith(O, [
                                b.read.cachedResponse(f)
                              ]))
                            : void (v.throttle
                                ? v.throttleFirstRequest || b.timer
                                  ? (b.debug('Throttling request', v.throttle),
                                  ...
                                  : (b.debug('Sending request', p, s.method),
                                    b.send.request(),
                                    (b.timer = setTimeout(function() {},
                                    v.throttle)))
                                : (b.debug('Sending request', p, s.method),
                                  b.send.request())))
                        : void 0)
                    : void b.error(R.missingURL))
            );
          },
          should: {
            removeError: function() {
              return (
                v.hideError === !0 || ('auto' === v.hideError && !b.is.form())
              );
            }
          },
          is: {
            ...
            abortedRequest: function(e) {
              return e && e.readyState !== n && 0 === e.readyState
                ? (b.verbose('XHR request determined to be aborted'), !0)
                : (b.verbose('XHR request was not aborted'), !1);
            },
            validResponse: function(t) {
              return b.is.expectingJSON() && e.isFunction(v.successTest)
                ? (b.debug('Checking JSON returned success', v.successTest, t),
                  v.successTest(t)
          ...
          add: {
                ...
                t &&
                  ...
                  o &&
                    ...
                    e.each(o, function(o, s) {
                      var i =
                          s.indexOf('$') !== -1
                            ? s.substr(2, s.length - 3)
                            : s.substr(1, s.length - 2),
                        a =
                          e.isPlainObject(r) && r[i] !== n
                            ? r[i]
                            : k.data(i) !== n
                              ? k.data(i)
                              : P.data(i) !== n
                                ...
                                : r[i];
                      return a === n
                        ? (b.error(R.requiredParameter, i, t), (t = !1), !1)
                        : (b.verbose('Found required variable', i, a),
                          (a = v.encodeParameters
                          ...
                          e.isPlainObject(r) && r[i] !== n
                            ...
                            : k.data(i) !== n
                              ...
                              : P.data(i) !== n
                                ...
                                : r[i];
                      a !== n
                        ? (b.verbose('Optional variable Found', i, a),
                          (t = t.replace(s, a)))
                        : (b.verbose('Optional variable not found', i),
                          (t =
                            t.indexOf('/' + s) !== -1
                              ? t.replace('/' + s, '')
                              : t.replace(s, '')));
            ...
            formData: function(t) {
              ...
              return (
                ...
                r
                  ? o
                    ? (b.debug('Extending existing data with form data', t, s),
                      (t = e.extend(!0, {}, t, s)))
                    : (b.error(R.missingSerialize),
                      b.debug(
                      ...
                      (t = s))
                  : (b.debug('Adding form data', s), (t = s)),
                t
              );
            }
          },
                ...
                (i = i > 0 ? i : 0),
                  ...
                  setTimeout(function() {
                    b.is.validResponse(t)
                      ? b.request.resolveWith(o, [t, n])
                      : b.request.rejectWith(o, [n, 'invalid']);
                  }, i);
              },
              fail: function(e, t, r) {
                var n = this,
                ...
                (s = s > 0 ? s : 0),
                  ...
                  setTimeout(function() {
                    b.is.abortedRequest(e)
                      ? b.request.rejectWith(n, [e, 'aborted', r])
                      : b.request.rejectWith(n, [e, 'error', t, r]);
                  }, s);
              }
            },
            request: {
              ...
              fail: function(e, t, r) {
                ...
                return 'aborted' == t
                  ...
                  : ('invalid' == t
                      ...
                      : 'error' == t &&
                        e !== n &&
                        (b.debug('XHR produced a server error', t, r),
                        200 != e.status &&
                          r !== n &&
                          '' !== r &&
                          b.error(R.statusMessage + r, s.url),
                    ...
                    v.errorDuration &&
                      ...
                      b.should.removeError() &&
                        setTimeout(b.remove.error, v.errorDuration)),
          ...
          create: {
            ...
            mockedXHR: function() {
              ...
              return (
                ...
                a
                  ? (e.isFunction(a)
                      ? (b.debug('Using specified synchronous callback', a),
                        (r = a.call(O, g)))
                      : (b.debug('Using settings specified response', a),
                        (r = a)),
                    n.resolveWith(O, [r, o, { responseText: r }]))
                  : e.isFunction(u) &&
                    ((t = function(e) {
                      b.debug('Async callback returned response', e),
                        e
                          ? n.resolveWith(O, [e, o, { responseText: e }])
                          : n.rejectWith(O, [{ responseText: e }, s, i]);
                    }),
          ...
          get: {
            ...
            errorFromRequest: function(t, r, o) {
              return e.isPlainObject(t) && t.error !== n
                ? t.error
                : v.error[r] !== n
                  ? v.error[r]
                  : o;
            ...
            urlEncodedValue: function(e) {
              ...
              return o
                ? (b.debug(
                  ...
                  e)
                : (b.verbose('Encoding value using encodeURIComponent', e, n),
                  n);
            },
            ...
            event: function() {
              return e.isWindow(j) || 'now' == v.on
                ? (b.debug('API called without element, no events attached'),
                  !1)
                : 'auto' == v.on
                  ? k.is('input')
                    ? j.oninput !== n
                      ? 'input'
                      : j.onpropertychange !== n
                        ? 'propertychange'
                        : 'keyup'
                    : k.is('form')
                      ? 'submit'
            ...
            templatedURL: function(e) {
              if (
                ((e = e || k.data(y.action) || v.action || !1),
                (f = k.data(y.url) || v.url || !1))
              )
                return b.debug('Using specified url', f), f;
              if (e) {
                if (
                  (b.debug('Looking up url for action', e, v.api),
                ...
                b.is.form() &&
                  ((f = k.attr('action') || P.attr('action') || !1),
                  b.debug(
            ...
            return (
              ...
              'string' == typeof t &&
                ...
                e.each(t, function(r, o) {
                  var s =
                    r != i
                      ? o + t[r + 1].charAt(0).toUpperCase() + t[r + 1].slice(1)
                      : t;
                  if (e.isPlainObject(c[s]) && r != i) c = c[s];
                  else {
                    if (c[s] !== n) return (a = c[s]), !1;
                    if (!e.isPlainObject(c[o]) || r == i)
                      return c[o] !== n
                        ? ((a = c[o]), !1)
                        : (b.error(R.method, t), !1);
                    c = c[o];
                  }
                })),
          ...
          d
            ? (w === n && b.initialize(), b.invoke(c))
            : (w !== n && w.invoke('destroy'), b.initialize());
      }),
      o !== n ? o : this
    );
  }),
