    ...
    (e.fn.tab = function(i) {
      ...
      return (
        r.each(function() {
          ...
          (v = {
            initialize: function() {
              v.debug('Initializing tab menu item', S),
                v.fix.callbacks(),
                v.determineTabs(),
                v.debug('Determining tabs', T.context, h),
                T.auto && v.set.auto(),
                v.bind.events(),
                T.history && !g && (v.initializeHistory(), (g = !0)),
                v.instantiate();
            },
            ...
            bind: {
              events: function() {
                e.isWindow(k) ||
                  (v.debug('Attaching tab activation events to element', S),
                  S.on('click' + C, v.event.click));
              }
            },
            determineTabs: function() {
              var t;
              'parent' === T.context
                ? (S.closest(A.ui).length > 0
                    ? ((t = S.closest(A.ui)),
                ...
                : T.context
                  ? ((f = e(T.context)),
                    v.verbose('Using selector for tab context', T.context, f))
                  : (f = e('body')),
                T.childrenOnly
                  ? ((h = f.children(A.tabs)),
                    v.debug('Searching tab context children for tabs', f, h))
                  : ((h = f.find(A.tabs)),
                    v.debug('Searching tab context for tabs', f, h));
            },
            fix: {
              callbacks: function() {
                e.isPlainObject(i) &&
                  ...
                  (i.onTabLoad &&
                    ...
                    delete i.onTabLoad,
                    v.error(P.legacyLoad, i.onLoad)),
                  i.onTabInit &&
                    ((i.onFirstLoad = i.onTabInit),
                    delete i.onTabInit,
                    v.error(P.legacyInit, i.onFirstLoad)),
                  (T = e.extend(!0, {}, e.fn.tab.settings, i)));
              }
            },
            initializeHistory: function() {
              if ((v.debug('Initializing page state'), e.address === n))
                return v.error(P.state), !1;
              if ('state' == T.historyType) {
                if ((v.debug('Using HTML5 to manage state'), T.path === !1))
                  return v.error(P.path), !1;
                ...
                a !== n
                  ? (T.history
                      ? (v.verbose('Updating page state', t),
                        e.address.value(a))
                      : (v.verbose('Changing tab', t), v.changeTab(a)),
                    t.preventDefault())
              ...
              history: {
                change: function(t) {
                  ...
                  v.performance.display(),
                    v.debug('History change event', a, t),
                    (y = t),
                    a !== n && v.changeTab(a),
                    i && e.address.title(i);
                }
              ...
              loading: function(e) {
                ...
                a ||
                  ...
                  t
                    .addClass(L.loading)
                    .siblings(h)
                    .removeClass(L.active + ' ' + L.loading),
                  t.length > 0 && T.onRequest.call(t[0], e));
              },
              state: function(t) {
                e.address.value(t);
              }
            ...
            changeTab: function(a) {
              var n = t.history && t.history.pushState,
                ...
                r =
                  o && !i
                    ? v.utilities.pathToArray(a)
                    : v.get.defaultPathArray(a);
              (a = v.utilities.arrayToPath(r)),
                e.each(r, function(t, n) {
                  ...
                  if ((v.verbose('Looking for tab', n), g)) {
                    if (
                      (v.verbose('Tab was found', n),
                      (p = b),
                      (m = v.utilities.filterArray(r, u)),
                      h
                        ? (d = !0)
                        : ((c = r.slice(0, t + 2)),
                          (l = v.utilities.arrayToPath(c)),
                          (d = !v.is.tab(l)),
                          d && v.verbose('Tab parameters found', c)),
                      d && o)
                    )
                      return (
                        i
                          ? (v.debug(
                            ...
                            (E = !1),
                            v.cache.add(a, A.html()),
                            v.activate.all(b),
                            T.onFirstLoad.call(A[0], b, m, y),
                            T.onLoad.call(A[0], b, m, y))
                          : (v.activate.navigation(b), v.fetch.content(b, a)),
                        !1
                      );
                    v.debug('Opened local tab', b),
                      v.activate.all(b),
                      v.cache.read(b) ||
                        (v.cache.add(b, !0),
                    ...
                    if (a.search('/') != -1 || '' === a)
                      return v.error(P.missingTab, S, f, b), !1;
                    if (
                      ((s = e('#' + a + ', a[name="' + a + '"]')),
                      (b = s.closest('[data-tab]').data(x.tab)),
                      (A = v.get.tabElement(b)),
                      s && s.length > 0 && b)
                    )
                      return (
                        v.debug('Anchor link used, opening parent tab', A, s),
                        A.hasClass(L.active) ||
                          setTimeout(function() {
                            v.scrollTo(s);
                          }, 0),
            ...
            scrollTo: function(t) {
              var n = !!(t && t.length > 0) && t.offset().top;
              n !== !1 &&
                (v.debug(
            ...
            update: {
              content: function(t, a, i) {
                var o = v.get.tabElement(t),
                  r = o[0];
                (i = i !== n ? i : T.evaluateScripts),
                  'string' == typeof T.cacheType &&
                  'dom' == T.cacheType.toLowerCase() &&
                  'string' != typeof a
                    ? o.empty().append(e(a).clone(!0))
                    : i
                      ? (v.debug(
                        ...
                        o.html(a))
                      : (v.debug('Updating HTML', t, a), (r.innerHTML = a));
              }
            },
            fetch: {
              content: function(t, a) {
                var i,
                  ...
                  s = {
                    ...
                    onSuccess: function(e) {
                      'response' == T.cacheType && v.cache.add(a, e),
                        v.update.content(t, e),
                        t == p
                          ? (v.debug('Content loaded', t), v.activate.tab(t))
                          : v.debug('Content loaded in background', t),
                        T.onFirstLoad.call(r[0], t, m, y),
                        T.onLoad.call(r[0], t, m, y),
                        'string' == typeof T.cacheType &&
                        'dom' == T.cacheType.toLowerCase() &&
                        r.children().length > 0
                          ? setTimeout(function() {
                ...
                (a = a || t),
                  ...
                  T.cache && o
                    ? (v.activate.tab(t),
                      v.debug('Adding cached content', a),
                      'once' == T.evaluateScripts
                        ? v.update.content(t, o, !1)
                        : v.update.content(t, o),
                      T.onLoad.call(r[0], t, m, y))
                    : l
                      ? (v.set.loading(t),
                        v.debug('Content is already loading', a))
                      : e.api !== n
                        ? ((i = e.extend(!0, {}, T.apiSettings, s)),
                          v.debug('Retrieving remote content', a, i),
                          v.set.loading(t),
                          r.api(i))
                        : v.error(P.api);
              }
            ...
            activate: {
              ...
              tab: function(e) {
                ...
                v.verbose('Showing tab content for', t),
                  n ||
                    (t.addClass(L.active),
                    a.removeClass(L.active + ' ' + L.loading),
                    t.length > 0 && T.onVisible.call(t[0], e));
              },
            ...
            is: {
              tab: function(e) {
                return e !== n && v.get.tabElement(e).length > 0;
              }
            },
            get: {
              ...
              defaultPath: function(e) {
                var t = r.filter('[data-' + x.tab + '^="' + e + '/"]').eq(0),
                  a = t.data(x.tab) || !1;
                if (a) {
                  if ((v.debug('Found default tab', a), w < T.maxDepth))
                    return w++, v.get.defaultPath(a);
                  v.error(P.recursion);
              ...
              tabElement: function(e) {
                ...
                return (
                  (e = e || p),
                  (n = v.utilities.pathToArray(e)),
                  (i = v.utilities.last(n)),
                  (t = h.filter('[data-' + x.tab + '="' + e + '"]')),
                  (a = h.filter('[data-' + x.tab + '="' + i + '"]')),
                  t.length > 0 ? t : a
                );
              },
              tab: function() {
            ...
            utilities: {
              ...
              pathToArray: function(e) {
                return (
                  e === n && (e = p), 'string' == typeof e ? e.split('/') : [e]
                );
              },
            ...
            setting: function(t, a) {
              if ((v.debug('Changing setting', t, a), e.isPlainObject(t)))
                e.extend(!0, T, t);
              else {
                if (a === n) return T[t];
                ...
                'string' == typeof t &&
                  ...
                  e.each(t, function(a, i) {
                    var o =
                      a != r
                        ? i +
                          t[a + 1].charAt(0).toUpperCase() +
                          t[a + 1].slice(1)
                        : t;
                    if (e.isPlainObject(l[o]) && a != r) l = l[o];
                    else {
                      if (l[o] !== n) return (s = l[o]), !1;
                      if (!e.isPlainObject(l[i]) || a == r)
                        return l[i] !== n
                          ? ((s = l[i]), !1)
                          : (v.error(P.method, t), !1);
                      l = l[i];
                    }
                  })),
                e.isFunction(s) ? (c = s.apply(i, a)) : s !== n && (c = s),
                e.isArray(o)
                  ? o.push(c)
                  : o !== n
                    ? (o = [o, c])
            ...
            u
              ? (I === n && v.initialize(), v.invoke(d))
              : (I !== n && I.invoke('destroy'), v.initialize());
        }),
        o !== n ? o : this
      );
    }),
