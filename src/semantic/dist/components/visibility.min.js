        ...
        c.each(function() {
          ...
          (v = {
            initialize: function() {
              v.debug('Initializing', h),
                ...
                v.should.trackChanges() &&
                  ...
                  v.bind.events()),
                v.save.position(),
                v.is.visible() || v.error(C.visible, k),
                h.initialCheck && v.checkVisibility(),
                v.instantiate();
            },
            instantiate: function() {
              v.debug('Storing instance', v), k.data(V, v), (O = v);
            },
            destroy: function() {
              v.verbose('Destroying previous module'),
                p && p.disconnect(),
                g && g.disconnect(),
                S.off('load' + R, v.event.load).off(
                  'resize' + R,
                  v.event.resize
                ),
                T.off('scroll' + R, v.event.scroll).off(
                  'scrollchange' + R,
                  v.event.scrollchange
                ),
                'fixed' == h.type && (v.resetFixed(), v.remove.placeholder()),
                k.off(R).removeData(V);
            },
            observeChanges: function() {
              'MutationObserver' in n &&
                ((g = new MutationObserver(v.event.contextChanged)),
                (p = new MutationObserver(v.event.changed)),
                g.observe(o, { childList: !0, subtree: !0 }),
            ...
            bind: {
              events: function() {
                v.verbose('Binding visibility events to scroll and resize'),
                  h.refreshOnLoad && S.on('load' + R, v.event.load),
                  S.on('resize' + R, v.event.resize),
                  T.off('scroll' + R)
                    .on('scroll' + R, v.event.scroll)
                    .on('scrollchange' + R, v.event.scrollchange);
              }
            },
            event: {
              changed: function(e) {
              ...
              contextChanged: function(n) {
                [].forEach.call(n, function(n) {
                  n.removedNodes &&
                    [].forEach.call(n.removedNodes, function(n) {
                      (n == z || e(n).find(z).length > 0) &&
                        (v.debug(
              ...
              resize: function() {
                v.debug('Window resized'), h.refreshOnResize && A(v.refresh);
              },
              load: function() {
                v.debug('Page finished loading'), A(v.refresh);
              },
              scroll: function() {
                h.throttle
                  ? (clearTimeout(v.timer),
                    (v.timer = setTimeout(function() {
                      T.triggerHandler('scrollchange' + R, [T.scrollTop()]);
                    }, h.throttle)))
                  : A(function() {
                      T.triggerHandler('scrollchange' + R, [T.scrollTop()]);
                    });
              },
              scrollchange: function(e, n) {
                v.checkVisibility(n);
              }
            },
            precache: function(n, t) {
            ...
            enableCallbacks: function() {
              v.debug('Allowing callbacks to occur'), (w = !1);
            },
            disableCallbacks: function() {
              v.debug('Disabling all callbacks temporarily'), (w = !0);
            },
            should: {
            ...
            setup: {
              ...
              image: function() {
                ...
                e &&
                  ...
                  (h.onOnScreen = function() {
                    v.debug('Image on screen', z),
                      v.precache(e, function() {
                        v.set.image(e, function() {
                          m++,
                            m == b && h.onAllLoaded.call(this),
                            h.onLoad.call(this);
                        });
                      });
                  }));
              ...
              fixed: function() {
                v.debug('Setting up fixed'),
                  ...
                  v.debug('Added placeholder', c),
                  (h.onTopPassed = function() {
                    v.debug('Element passed, adding fixed position', k),
                      v.show.placeholder(),
                      v.set.fixed(),
                      h.transition &&
                        e.fn.transition !== t &&
                        k.transition(h.transition, h.duration);
                  }),
                  (h.onTopPassedReverse = function() {
                    v.debug('Element returned to position, removing fixed', k),
                      v.hide.placeholder(),
                      v.remove.fixed();
                  });
              }
            ...
            show: {
              placeholder: function() {
                v.verbose('Showing placeholder'),
                  c.css('display', 'block').css('visibility', 'hidden');
              }
            },
            hide: {
              placeholder: function() {
                v.verbose('Hiding placeholder'),
                  c.css('display', 'none').css('visibility', '');
              }
            },
            set: {
              fixed: function() {
              ...
              image: function(n, o) {
                k.attr('src', n),
                  h.transition
                    ? e.fn.transition !== t
                      ? k.transition(h.transition, h.duration, o)
                      : k.fadeIn(h.duration, o)
                    : k.show();
              }
            },
            is: {
            ...
            checkVisibility: function(e) {
              v.verbose('Checking visibility of element', v.cache.element),
                !w &&
                  ...
                  v.bottomPassed(),
                  h.onUpdate &&
                    h.onUpdate.call(z, v.get.elementCalculations()));
            },
            passed: function(n, o) {
              var i = v.get.elementCalculations();
              if (n && o) h.onPassed[n] = o;
              else {
                if (n !== t) return v.get.pixelsPassed(n) > i.pixelsPassed;
                i.passing &&
                  e.each(h.onPassed, function(e, n) {
                    i.bottomVisible || i.pixelsPassed > v.get.pixelsPassed(e)
                      ? v.execute(n, e)
                      : h.once || v.remove.occurred(n);
                  });
              }
            },
            onScreen: function(e) {
              ...
              if (
                (e &&
                  ...
                  (h.onOnScreen = e)),
                n.onScreen ? v.execute(o, i) : h.once || v.remove.occurred(i),
                e !== t)
              )
                return n.onOnScreen;
            },
            offScreen: function(e) {
              ...
              if (
                (e &&
                  ...
                  (h.onOffScreen = e)),
                n.offScreen ? v.execute(o, i) : h.once || v.remove.occurred(i),
                e !== t)
              )
                return n.onOffScreen;
            },
            passing: function(e) {
              var n = v.get.elementCalculations(),
                o = e || h.onPassing,
              ...
              if (
                (e &&
                  ...
                  (h.onPassing = e)),
                n.passing ? v.execute(o, i) : h.once || v.remove.occurred(i),
                e !== t)
              )
                return n.passing;
            },
            topVisible: function(e) {
              ...
              if (
                (e &&
                  ...
                  (h.onTopVisible = e)),
                n.topVisible ? v.execute(o, i) : h.once || v.remove.occurred(i),
                e === t)
              )
                return n.topVisible;
            },
            bottomVisible: function(e) {
              ...
              if (
                ...
                n.bottomVisible
                  ? v.execute(o, i)
                  : h.once || v.remove.occurred(i),
                e === t)
              )
                return n.bottomVisible;
            },
            topPassed: function(e) {
              ...
              if (
                (e &&
                  ...
                  (h.onTopPassed = e)),
                n.topPassed ? v.execute(o, i) : h.once || v.remove.occurred(i),
                e === t)
              )
                return n.topPassed;
            },
            bottomPassed: function(e) {
              ...
              if (
                ...
                return n.bottomPassed;
            },
            passingReverse: function(e) {
              var n = v.get.elementCalculations(),
                o = e || h.onPassingReverse,
                i = 'passingReverse';
              if (
                (e &&
                ...
                n.passing
                  ? h.once || v.remove.occurred(i)
                  : v.get.occurred('passing') && v.execute(o, i),
                e !== t)
              )
                return !n.passing;
            },
            topVisibleReverse: function(e) {
              ...
              if (
                ...
                n.topVisible
                  ? h.once || v.remove.occurred(i)
                  : v.get.occurred('topVisible') && v.execute(o, i),
                e === t)
              )
                return !n.topVisible;
            },
            bottomVisibleReverse: function(e) {
              ...
              if (
                ...
                n.bottomVisible
                  ? h.once || v.remove.occurred(i)
                  : v.get.occurred('bottomVisible') && v.execute(o, i),
                e === t)
              )
                return !n.bottomVisible;
            },
            topPassedReverse: function(e) {
              ...
              if (
                ...
                n.topPassed
                  ? h.once || v.remove.occurred(i)
                  : v.get.occurred('topPassed') && v.execute(o, i),
                e === t)
              )
                return !n.onTopPassed;
            },
            bottomPassedReverse: function(e) {
              var n = v.get.elementCalculations(),
                o = e || h.onBottomPassedReverse,
              ...
              if (
                ...
                n.bottomPassed
                  ? h.once || v.remove.occurred(i)
                  : v.get.occurred('bottomPassed') && v.execute(o, i),
                e === t)
              )
                return !n.bottomPassed;
            },
            execute: function(e, n) {
              var o = v.get.elementCalculations(),
                t = v.get.screenCalculations();
              (e = e || !1),
                e &&
                  (h.continuous
                    ? (v.debug('Callback being called continuously', n, o),
                      e.call(z, o, t))
                    : v.get.occurred(n) ||
                      (v.debug('Conditions met', n, o), e.call(z, o, t))),
                v.save.occurred(n);
            },
            remove: {
              fixed: function() {
              ...
              placeholder: function() {
                v.debug('Removing placeholder content'), c && c.remove();
              },
              occurred: function(e) {
                if (e) {
                  var n = v.cache.occurred;
                  n[e] !== t &&
                    n[e] === !0 &&
            ...
            save: {
              ...
              occurred: function(e) {
                e &&
                  ((v.cache.occurred[e] !== t && v.cache.occurred[e] === !0) ||
              ...
              elementCalculations: function() {
                var e = v.get.screenCalculations(),
                  n = v.get.elementPosition();
                return (
                  h.includeMargin
                    ? ((n.margin = {}),
                      (n.margin.top = parseInt(k.css('margin-top'), 10)),
                      (n.margin.bottom = parseInt(k.css('margin-bottom'), 10)),
                      (n.top = n.offset.top - n.margin.top),
                      (n.bottom = n.offset.top + n.height + n.margin.bottom))
                    : ((n.top = n.offset.top),
                      (n.bottom = n.offset.top + n.height)),
                  (n.topVisible = e.bottom >= n.top),
                  (n.topPassed = e.top >= n.top),
                  (n.bottomVisible = e.bottom >= n.bottom),
                  (n.bottomPassed = e.top >= n.bottom),
                  (n.pixelsPassed = 0),
                  (n.percentagePassed = 0),
                  (n.onScreen = n.topVisible && !n.bottomPassed),
                  (n.passing = n.topPassed && !n.bottomPassed),
                  (n.offScreen = !n.onScreen),
                  n.passing &&
                    ((n.pixelsPassed = e.top - n.top),
                    (n.percentagePassed = (e.top - n.top) / n.height)),
                  (v.cache.element = n),
                  v.verbose('Updated element calculations', n),
                  n
                );
              },
              ...
              screenSize: function() {
                v.verbose('Saving window position'),
                  (v.cache.screen = { height: T.height() });
              },
              position: function() {
            ...
            get: {
              pixelsPassed: function(e) {
                var n = v.get.elementCalculations();
                return e.search('%') > -1
                  ? n.height * (parseInt(e, 10) / 100)
                  : parseInt(e, 10);
              },
              occurred: function(e) {
                return v.cache.occurred !== t && (v.cache.occurred[e] || !1);
              },
              direction: function() {
                return (
                  v.cache.direction === t && v.save.direction(),
                  v.cache.direction
                );
              },
              elementPosition: function() {
                return (
                  v.cache.element === t && v.save.elementPosition(),
                  v.cache.element
                );
              },
              elementCalculations: function() {
                return (
                  v.cache.element === t && v.save.elementCalculations(),
                  v.cache.element
                );
              },
              screenCalculations: function() {
                return (
                  v.cache.screen === t && v.save.screenCalculations(),
                  v.cache.screen
                );
              },
              screenSize: function() {
                return (
                  v.cache.screen === t && v.save.screenSize(), v.cache.screen
                );
              },
              scroll: function() {
                return v.cache.scroll === t && v.save.scroll(), v.cache.scroll;
              },
              lastScroll: function() {
                return v.cache.screen === t
                  ? (v.debug(
            ...
            internal: function(n, o) {
              if (e.isPlainObject(n)) e.extend(!0, v, n);
              else {
                if (o === t) return v[n];
                v[n] = o;
              }
                ...
                'string' == typeof n &&
                  ...
                  e.each(n, function(o, i) {
                    var s =
                      o != c
                        ? i +
                          n[o + 1].charAt(0).toUpperCase() +
                          n[o + 1].slice(1)
                        : n;
                    if (e.isPlainObject(l[s]) && o != c) l = l[s];
                    else {
                      if (l[s] !== t) return (r = l[s]), !1;
                      if (!e.isPlainObject(l[i]) || o == c)
                        return l[i] !== t
                          ? ((r = l[i]), !1)
                          : (v.error(C.method, n), !1);
                      l = l[i];
                    }
                  })),
                e.isFunction(r) ? (a = r.apply(i, o)) : r !== t && (a = r),
                e.isArray(s)
                  ? s.push(a)
                  : s !== t
                    ? (s = [s, a])
            ...
            u
              ? (O === t && v.initialize(),
                ...
                O.save.calculations(),
                v.invoke(d))
              : (O !== t && O.invoke('destroy'), v.initialize());
        }),
        s !== t ? s : this
      );
    }),
