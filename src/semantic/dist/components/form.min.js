        ...
        a.each(function() {
          ...
          (T = {
            initialize: function() {
              T.get.settings(),
                f
                  ? (A === r && T.instantiate(), T.invoke(u))
                  : (A !== r && A.invoke('destroy'),
            ...
            bindEvents: function() {
              T.verbose('Attaching form events'),
                j
                  .on('submit' + F, T.validate.form)
                  .on('blur' + F, w.field, T.event.field.blur)
                  .on('click' + F, w.submit, T.submit)
                  .on('click' + F, w.reset, T.reset)
                  .on('click' + F, w.clear, T.clear),
                x.keyboardShortcuts &&
                  j.on('keydown' + F, w.field, T.event.field.keydown),
                p.each(function() {
                  var t = e(this),
                    n = t.prop('type'),
            ...
            clear: function() {
              p.each(function() {
                ...
                s &&
                  (T.verbose('Resetting error on field', r),
                  r.removeClass(C.error),
                  i.remove()),
                  l
                    ? (T.verbose('Resetting dropdown value', n, a),
                      n.dropdown('clear'))
                    : o
                      ? t.prop('checked', !1)
                      : (T.verbose('Resetting field value', t, a), t.val(''));
              });
            },
            reset: function() {
              p.each(function() {
                ...
                o !== r &&
                  (u &&
                    (T.verbose('Resetting error on field', i),
                    i.removeClass(C.error),
                    a.remove()),
                  s
                    ? (T.verbose('Resetting dropdown value', n, o),
                      n.dropdown('restore defaults'))
                    : l
                      ? (T.verbose('Resetting checkbox value', n, o),
                        t.prop('checked', o))
                      : (T.verbose('Resetting field value', t, o), t.val(o)));
              });
            },
            is: {
              ...
              valid: function() {
                var t = !0;
                return (
                  T.verbose('Checking if form is valid'),
              ...
              field: {
                keydown: function(t) {
                  var n = e(this),
                    ...
                    l = { enter: 13, escape: 27 };
                  r == l.escape &&
                    (T.verbose('Escape key pressed blurring field'), n.blur()),
                    t.ctrlKey ||
                      r != l.enter ||
                      !i ||
                      o ||
                      a ||
                      (z ||
                        (n.one('keyup' + F, T.event.field.keyup),
                        T.submit(),
                ...
                blur: function(t) {
                  ...
                  r.hasClass(C.error)
                    ? (T.debug('Revalidating field', n, i),
                      i && T.validate.field(i))
                ...
                change: function(t) {
                  var n = e(this),
                    r = n.closest(m),
                    i = T.get.validation(n);
                  ('change' == x.on || (r.hasClass(C.error) && x.revalidate)) &&
            ...
            get: {
              ancillaryValue: function(e) {
                return (
                  !(!e.type || (!e.value && !T.is.bracketedRule(e))) &&
                  (e.value !== r
                    ? e.value
              ...
              inputEvent: function() {
                return n.createElement('input').oninput !== r
                  ? 'input'
                  : n.createElement('input').onpropertychange !== r
                    ? 'propertychange'
                    : 'keyup';
              },
              prompt: function(e, t) {
                var n,
                  ...
                  u = l.search('{name}') !== -1;
                return (
                  (u || s) && (r = T.get.field(t.identifier)),
                  ...
                  u &&
                    ...
                    (i =
                      1 == n.length
                        ? n.text()
                        : r.prop('placeholder') || x.text.unspecifiedField),
                    (l = l.replace('{name}', i))),
                  (l = l.replace('{identifier}', t.identifier)),
                  (l = l.replace('{ruleValue}', o)),
                  e.prompt ||
                    T.verbose('Using default validation prompt for type', l, a),
                  l
                );
              },
              settings: function() {
                if (e.isPlainObject(t)) {
                  var n,
                    ...
                    a =
                      i.length > 0 &&
                      (t[i[0]].identifier !== r && t[i[0]].rules !== r);
                  a
                    ? ((x = e.extend(!0, {}, e.fn.form.settings, c)),
              ...
              field: function(t) {
                return (
                  T.verbose('Finding field with identifier', t),
                  p.filter('#' + t).length > 0
                    ? p.filter('#' + t)
                    : p.filter('[name="' + t + '"]').length > 0
                      ? p.filter('[name="' + t + '"]')
                      : p.filter('[name="' + t + '[]"]').length > 0
                        ? p.filter('[name="' + t + '[]"]')
                        : p.filter('[data-' + E.validate + '="' + t + '"]')
                            .length > 0
                          ? p.filter('[data-' + E.validate + '="' + t + '"]')
                          : e('<input/>')
                );
              ...
              value: function(e) {
                var t,
                  n = [];
                return n.push(e), (t = T.get.values.call(D, n)), t[e];
              },
              values: function(t) {
                ...
                return (
                  ...
                  p.filter('#' + e).length > 0 ||
                    (p.filter('[name="' + e + '"]').length > 0 ||
                      p.filter('[data-' + E.validate + '="' + e + '"]').length >
                        0)
                );
              }
            },
            add: {
              prompt: function(t, n) {
                ...
                (n = 'string' == typeof n ? [n] : n),
                  ...
                  a.addClass(C.error),
                  x.inline &&
                    (l || ((o = x.templates.prompt(n)), o.appendTo(a)),
                    o.html(n[0]),
                    l
                      ? T.verbose(
                      ...
                      : x.transition &&
                        ...
                        ? (T.verbose(
                          ...
                          o.transition(x.transition + ' in', x.duration))
                        : (T.verbose(
            ...
            remove: {
              prompt: function(t) {
                ...
                i.removeClass(C.error),
                  x.inline &&
                    a.is(':visible') &&
                    (T.verbose('Removing prompt for field', t),
                    x.transition &&
                    e.fn.transition !== r &&
                    j.transition('is supported')
                      ? a.transition(
            ...
            set: {
              ...
              value: function(e, t) {
                var n = {};
                return (n[e] = t), T.set.values.call(D, n);
              },
              values: function(t) {
                e.isEmptyObject(t) ||
                  e.each(t, function(t, n) {
                    ...
                    c &&
                      (o && l
                        ? (T.verbose('Selecting multiple', n, i),
                          a.checkbox('uncheck'),
                        ...
                        : u
                          ? (T.verbose('Selecting radio value', n, i),
                            i
                              .filter('[value="' + n + '"]')
                              .parent(w.uiCheckbox)
                              .checkbox('check'))
                          : l
                            ? (T.verbose('Setting checkbox value', n, a),
                              n === !0
                                ? a.checkbox('check')
                                : a.checkbox('uncheck'))
                            : s
                              ? (T.verbose('Setting dropdown value', n, a),
                                a.dropdown('set selected', n))
                              : (T.verbose('Setting field value', n, i),
                                i.val(n)));
                  });
              }
            },
            validate: {
              form: function(e, t) {
                ...
                if (((O = []), T.is.valid())) {
                  if (
                    (T.debug('Form has no validation errors, submitting'),
                    T.set.success(),
                    t !== !0)
                  )
                    return x.onSuccess.call(D, e, n);
                } else if (
                  (T.debug('Form has errors'),
                  T.set.error(),
              ...
              field: function(t, n) {
                ...
                return (
                  t.identifier ||
                    (T.debug('Using field name as identifier', i),
                    (t.identifier = i)),
                  a.prop('disabled')
                    ? (T.debug('Field is disabled. Skipping', i), (l = !0))
                    : t.optional && T.is.blank(a)
                      ? (T.debug('Field is optional and blank. Skipping', i),
                        (l = !0))
                      : t.depends && T.is.empty(o)
                        ? (T.debug(
                        ...
                        : t.rules !== r &&
                          e.each(t.rules, function(e, n) {
                            T.has.field(i) &&
                              !T.validate.rule(t, n) &&
                              (T.debug('Field is invalid', i, n.type),
                              s.push(T.get.prompt(n, t)),
                              (l = !1));
                          }),
                  l
                    ? (T.remove.prompt(i, s), x.onValid.call(a), !0)
                    : ((O = O.concat(s)),
                      T.add.prompt(i, s),
              ...
              rule: function(t, n) {
                ...
                return e.isFunction(s)
                  ? ((a =
                      a === r || '' === a || null === a ? '' : e.trim(a + '')),
                    s.call(i, a, o))
                  : void T.error(V.noRule, l);
              }
            },
                    ...
                    var a =
                      n != o
                        ? i +
                          ...
                          t[n + 1].slice(1)
                        : t;
                    if (e.isPlainObject(u[a]) && n != o) u = u[a];
                    else {
                      if (u[a] !== r) return (l = u[a]), !1;
                      if (!e.isPlainObject(u[i]) || n == o)
                        return u[i] !== r && ((l = u[i]), !1);
                      u = u[i];
                    }
                  })),
    ...
    (e.fn.form.settings = {
      ...
      rules: {
        ...
        regExp: function(t, n) {
          ...
          var r,
            i = n.match(e.fn.form.settings.regExp.flags);
          return (
            i &&
              ((n = i.length >= 2 ? i[1] : n), (r = i.length >= 3 ? i[2] : '')),
        ...
        integer: function(t, n) {
          var i,
            a,
            o,
            l = e.fn.form.settings.regExp.integer;
          return (
            n &&
              ['', '..'].indexOf(n) === -1 &&
              (n.indexOf('..') == -1
        ...
        creditCard: function(t, n) {
          ...
          if ('string' == typeof t && 0 !== t.length) {
            ...
            for (
              ...
              (d += f[c][parseInt(t.charAt(u), 10)]), (c ^= 1);
            return d % 10 === 0 && d > 0;
          }
        },
        ...
        maxCount: function(e, t) {
          return (
            0 != t && (1 == t ? e.search(',') === -1 : e.split(',').length <= t)
          );
        }
      }
    });
