      ...
      return (
        s.each(function(h) {
          var g,
            ...
            y,
            A = e.isPlainObject(a)
              ? e.extend(!0, {}, e.fn.dropdown.settings, a)
          ...
          (y = {
            ...
            observeChanges: function() {
              'MutationObserver' in t &&
                ((C = new MutationObserver(y.event.select.mutation)),
            ...
            observe: {
              select: function() {
                y.has.input() &&
                  C.observe(N[0], { childList: !0, subtree: !0 });
              },
              menu: function() {
                y.has.menu() && S.observe(W[0], { childList: !0, subtree: !0 });
              }
            },
            create: {
              id: function() {
              ...
              userChoice: function(t) {
                ...
                return (
                  ...
                  e.each(t, function(t, s) {
                    y.get.item(s) === !1 &&
                      ((o = A.templates.addition(
                        y.add.variables(k.addResult, s)
                      )),
                      (a = e('<div />')
                        .html(o)
                        .attr('data-' + D.value, s)
            ...
            select: {
              ...
              nextAvailable: function(e) {
                ...
                i
                  ...
                  : (y.verbose('Moving selection to', n),
            ...
            setup: {
              api: function() {
                ...
                y.verbose('First request, initializing API'), z.api(e);
              },
              layout: function() {
                z.is('select') && (y.setup.select(), y.setup.returnedObject()),
                  ...
                  N.parent(O.dropdown).length > 0
                    ...
                    : (y.debug('Creating entire dropdown from select'),
                      (z = e('<div />')
                        ...
                        .html(E.dropdown(t))
                        .insertBefore(N)),
                      N.hasClass(T.multiple) &&
                        N.prop('multiple') === !1 &&
                        (y.error(V.missingMultiple), N.prop('multiple', !0)),
                      N.is('[multiple]') && y.set.multiple(),
                      N.prop('disabled') &&
                        (y.debug('Disabling dropdown'), z.addClass(T.disabled)),
                      N.removeAttr('class')
                        .detach()
                        .prependTo(z)),
                  y.refresh();
            ...
            bind: {
              ...
              touchEvents: function() {
                y.debug(
                  ...
                  y.is.searchSelection() ||
                    (y.is.single() &&
                      z.on('touchstart' + F, y.event.test.toggle)),
              ...
              keyboardEvents: function() {
                y.verbose('Binding keyboard events'),
                  ...
                  y.has.search() &&
                    z.on(y.get.inputEvent() + F, O.search, y.event.input),
                  y.is.multiple() &&
                    r.on('keydown' + w, y.event.document.keydown);
              },
              ...
              mouseEvents: function() {
                y.verbose('Binding mouse events'),
                  y.is.multiple() &&
                    z
                      .on('click' + F, O.label, y.event.label.click)
                      .on('click' + F, O.remove, y.event.remove.click),
                  y.is.searchSelection()
                    ? (z
                        .on('mousedown' + F, y.event.mousedown)
                        .on('mouseup' + F, y.event.mouseup)
                        .on('mousedown' + F, O.menu, y.event.menu.mousedown)
                        .on('mouseup' + F, O.menu, y.event.menu.mouseup)
                        .on('click' + F, O.icon, y.event.icon.click)
                        .on('focus' + F, O.search, y.event.search.focus)
                        .on('click' + F, O.search, y.event.search.focus)
                        .on('blur' + F, O.search, y.event.search.blur)
                        .on('click' + F, O.text, y.event.text.focus),
                      y.is.multiple() && z.on('click' + F, y.event.click))
                    : ('click' == A.on
                        ? z
                            .on('click' + F, O.icon, y.event.icon.click)
                            .on('click' + F, y.event.test.toggle)
                        : 'hover' == A.on
                          ? z
                              .on('mouseenter' + F, y.delay.show)
                              .on('mouseleave' + F, y.delay.hide)
                          : z.on(A.on + F, y.toggle),
                      z
                        .on('mousedown' + F, y.event.mousedown)
                        .on('mouseup' + F, y.event.mouseup)
                        .on('focus' + F, y.event.focus)
                        .on('blur' + F, y.event.blur)),
                  W.on('mouseenter' + F, O.item, y.event.item.mouseenter)
                    .on('mouseleave' + F, O.item, y.event.item.mouseleave)
                    .on('click' + F, O.item, y.event.item.click);
              },
              intent: function() {
                y.verbose('Binding hide intent event to document'),
                  c &&
                    r
                      .on('touchstart' + w, y.event.test.touch)
                      .on('touchmove' + w, y.event.test.touch),
            ...
            filter: function(e) {
                      ...
                      ? A.onNoResults.call(J, t)
                        ? A.allowAdditions
                          ...
                          : (y.verbose(
                            ...
                            y.add.message(k.noResults))
                        : (y.verbose('All items filtered, hiding dropdown', t),
                          y.hideMenu())
              ...
              (A.useLabels && y.has.maxSelections()) ||
                (A.apiSettings
                  ? y.can.useAPI()
            ...
            queryRemote: function(t, n) {
              var i = {
                ...
                onSuccess: function(e) {
                  y.remove.message(),
                    y.setup.menu({ values: e[L.remoteValues] }),
                    n();
                }
              };
              ...
              y.has.query() &&
                ...
                $.each(function() {
                  ...
                  if ('both' == A.match || 'value' == A.match) {
                    if (
                      ((i = String(y.get.choiceValue(o, t))),
                      i.search(s) !== -1)
                    )
                      return a.push(this), !0;
            ...
            exactSearch: function(e, t) {
              return (
                (e = e.toLowerCase()), (t = t.toLowerCase()), t.indexOf(e) > -1
              );
            },
            ...
            focusSearch: function(e) {
              y.has.search() &&
                !y.is.focusedOnSearch() &&
                (e
                  ? (z.off('focus' + F, O.search),
                    j.focus(),
                    z.on('focus' + F, O.search, y.event.search.focus))
                  : j.focus());
            },
            forceSelection: function() {
              var e = $.not(T.filtered)
                  .filter('.' + T.selected)
                  .eq(0),
                t = $.not(T.filtered)
                  .filter('.' + T.active)
                ...
                i = n.length > 0;
              return i
                ? (y.debug('Forcing partial selection to selected item', n),
                  void y.event.item.click.call(n, {}, !0))
                : void (A.allowAdditions
                ...
                blur: function(e) {
                  (p = n.activeElement === this),
                    b ||
                      Y ||
                      p ||
                      (A.forceSelection && y.forceSelection(), y.hide()),
                    (b = !1);
                }
              },
              icon: {
                    ...
                    r =
                      o.length > 0
                        ...
                        : n
                            ...
                            .add(n);
                  t.shiftKey
                    ? (a.removeClass(T.active), r.addClass(T.active))
                    : t.ctrlKey
                      ? n.toggleClass(T.active)
                      : (a.removeClass(T.active), n.addClass(T.active)),
              ...
              test: {
                toggle: function(e) {
                  ...
                  y.is.bubbledLabelClick(e) ||
                    y.is.bubbledIconClick(e) ||
                    (y.determine.eventOnElement(e, t) && e.preventDefault());
                },
                touch: function(e) {
              ...
              item: {
                ...
                click: function(t, n) {
                  var i = e(this),
                    ...
                    c = o.find(a).length > 0;
                  c ||
                    (l && !A.allowCategorySelection) ||
                    (y.is.searchSelection() &&
                      (A.allowAdditions && y.remove.userAddition(),
                      y.remove.searchTerm(),
                      y.is.focusedOnSearch() || 1 == n || y.focusSearch(!0)),
                    A.useLabels ||
                      (y.remove.filteredItem(), y.set.scrollPosition(i)),
                  ...
                  if (n) {
                    ...
                    t == I.leftArrow
                      ? (!m && !f) || r
                        ? r &&
                          (e.shiftKey
                            ? y.verbose('Adding previous label to selection')
                      ...
                      : t == I.rightArrow
                        ? (m && !r && i.first().addClass(T.active),
                          r &&
                            (e.shiftKey
                              ? y.verbose('Adding next label to selection')
                            ...
                            u
                              ? d
                                ? v
                                  ...
                                  : y.focusSearch()
                                : l
                                  ? a.next(O.siblingLabel).addClass(T.active)
                                  : a.addClass(T.active)
                              : a.next(O.siblingLabel).addClass(T.active),
                            e.preventDefault()))
              ...
              keydown: function(e) {
                ...
                if (n) {
                  var i,
                    ...
                    l =
                      r.length > 0
                        ? r.siblings(':not(.' + T.filtered + ')').addBack()
                        : W.children(':not(.' + T.filtered + ')'),
                    c = r.children(O.menu),
                    u = r.closest(O.menu),
                    d =
                      u.hasClass(T.visible) ||
                      u.hasClass(T.animating) ||
                      u.parent(O.menu).length > 0,
                    v = c.length > 0,
                    m = r.length > 0,
                    f = r.not(O.unselectable).length > 0,
                    h = t == I.delimiter && A.allowAdditions && y.is.multiple(),
                    g =
                      A.allowAdditions &&
                      A.hideAdditions &&
                      (t == I.enter || h) &&
                  ...
                  if (
                    (g &&
                      (y.verbose('Selecting item from keyboard shortcut', r),
                    ...
                    if (
                      ((t == I.enter || h) &&
                        (t == I.enter && m && v && !A.allowCategorySelection
                          ? (y.verbose(
                      ...
                      m &&
                        (t == I.leftArrow &&
                          ((a = u[0] !== W[0]),
                          a &&
                            (y.verbose('Left key pressed, closing sub-menu'),
                            y.animate.hide(!1, u),
                        ...
                        t == I.rightArrow &&
                          v &&
                          (y.verbose('Right key pressed, opening sub-menu'),
                          y.animate.show(!1, c),
                          r.removeClass(T.selected),
                          c
                            .find(O.item)
                    ...
                    t == I.pageUp && (y.scrollPage('up'), e.preventDefault()),
                      t == I.pageDown &&
                        (y.scrollPage('down'), e.preventDefault()),
                      t == I.escape &&
                        (y.verbose('Escape key pressed, closing dropdown'),
                        y.hide());
                  } else
                    h && e.preventDefault(),
                      t != I.downArrow ||
            ...
            determine: {
              selectAction: function(t, n) {
                y.verbose('Determining action', A.action),
                  e.isFunction(y.action[A.action])
                    ? (y.verbose('Triggering preset action', A.action, t, n),
                      y.action[A.action].call(J, t, n, this))
                    : e.isFunction(A.action)
                      ? (y.verbose('Triggering user action', A.action, t, n),
                        A.action.call(J, t, n, this))
                      : y.error(V.action, A.action);
              },
              eventInModule: function(t, i) {
                ...
                return (
                  ...
                  o && !s
                    ? (y.verbose('Triggering event', i), i(), !0)
                    : (y.verbose(
            ...
            get: {
              ...
              choiceText: function(t, n) {
                if (((n = n !== i ? n : A.preserveHTML), t))
                  return (
                    t.find(O.menu).length > 0 &&
                      (y.verbose('Retrieving text of element with sub-menu'),
                      (t = t.clone()),
              ...
              selectValues: function() {
                ...
                return (
                  ...
                  z.find('option').each(function() {
                    ...
                    'auto' === A.placeholder && '' === s
                      ? (t.placeholder = a)
                      : t.values.push({ name: a, value: s, disabled: o });
                  }),
                  A.placeholder &&
                    'auto' !== A.placeholder &&
                    (y.debug('Setting placeholder value to', A.placeholder),
                    (t.placeholder = A.placeholder)),
                  A.sortSelect
                    ? (t.values.sort(function(e, t) {
                        return e.name > t.name ? 1 : -1;
                      }),
                      y.debug('Retrieved and sorted values from select', t))
            ...
            restore: {
              ...
              labels: function() {
                A.allowAdditions &&
                  (A.useLabels || (y.error(V.labels), (A.useLabels = !0)),
              ...
              values: function() {
                y.set.initialLoad(),
                  A.apiSettings && A.saveRemoteData && y.get.remoteValues()
            ...
            save: {
              ...
              remoteData: function(e, n) {
                return t.Storage === i
                  ? void y.error(V.noStorage)
                  : (y.verbose('Saving remote data to session storage', n, e),
                    void sessionStorage.setItem(n, e));
              }
            },
            clear: function() {
              y.is.multiple() && A.useLabels
                ? y.remove.labels()
                : (y.remove.activeItem(), y.remove.selectedItem()),
                y.set.placeholderText(),
                y.clearValue();
            ...
            set: {
              filtered: function() {
                ...
                e &&
                  a &&
                  (y.verbose('Adjusting input width', o, A.glyphWidth),
                  j.css('width', o)),
                  a || (n && s)
                    ? (y.verbose('Hiding placeholder text'),
                      H.addClass(T.filtered))
                    : (!e || (n && !s)) &&
              ...
              tabbable: function() {
                y.has.search()
                  ...
                  : (y.debug('Added tabindex to dropdown'),
                    z.attr('tabindex') === i &&
                      (z.attr('tabindex', 0), W.attr('tabindex', -1)));
              },
              initialLoad: function() {
                y.verbose('Setting initial load'), (g = !0);
              },
              activeItem: function(e) {
                A.allowAdditions && e.filter(O.addition).length > 0
              ...
              text: function(e) {
                'select' !== A.action &&
                  ('combo' == A.action
                    ? (y.debug('Changing combo button text', e, B),
                      A.preserveHTML ? B.html(e) : B.text(e))
                    : (e !== y.get.placeholderText() &&
                        H.removeClass(T.placeholder),
              ...
              direction: function(e) {
                'auto' == A.direction
                  ? y.is.onScreen(e)
                    ? y.remove.upward(e)
                    : y.set.upward(e)
                  : 'upward' == A.direction && y.set.upward(e);
              },
              upward: function(e) {
                var t = e || z;
                t.addClass(T.upward);
              ...
              value: function(e, t, n) {
                ...
                if (o) {
                  ...
                  y.is.single() &&
                    y.has.selectInput() &&
                    y.can.extendSelect() &&
                    (y.debug('Adding user option', e), y.add.optionValue(e)),
                    y.debug('Updating input value', a, s),
                    (G = !0),
                    N.val(a),
                    A.fireOnInit === !1 && y.is.initialLoad()
                      ? y.debug(
                ...
                A.fireOnInit === !1 && y.is.initialLoad()
                  ? y.verbose('No callback on initial load', A.onChange)
                  : A.onChange.call(J, e, t, n);
              },
              active: function() {
                z.addClass(T.active);
              },
              ...
              selected: function(t, n) {
                var i = y.is.multiple();
                (n = A.allowAdditions
                  ? n || y.get.itemWithAdditions(t)
                  : n || y.get.item(t)),
                  n &&
                    (y.debug('Setting selected menu item to', n),
                    y.is.multiple() && y.remove.searchWidth(),
                    y.is.single()
                      ? (y.remove.activeItem(), y.remove.selectedItem())
                      : A.useLabels && y.remove.selectedItem(),
                    n.each(function() {
                      var t = e(this),
                      ...
                      i
                        ? !r || l
                          ? (A.apiSettings &&
                              A.saveRemoteData &&
                              y.save.remoteData(a, o),
                            A.useLabels
                              ? (y.add.value(o, a, t),
                                y.add.label(o, a, c),
                                y.set.activeItem(t),
                                y.filterActive(),
                                y.select.nextAvailable(n))
                              : (y.add.value(o, a, t),
                                y.set.text(y.add.variables(k.count)),
                                y.set.activeItem(t)))
                          : s ||
                            (y.debug('Selected active value, removing label'),
                            y.remove.selected(o))
                        : (A.apiSettings &&
                            A.saveRemoteData &&
                            y.save.remoteData(a, o),
            ...
            add: {
              label: function(t, n, i) {
                ...
                return (
                  ...
                  y.has.label(t)
                    ? void y.debug('Label already exists, skipping', s)
                    : (A.label.variation && a.addClass(A.label.variation),
                      void (i === !0
                        ? (y.debug('Animating in label', a),
                          a
                            .addClass(T.hidden)
                            .insertBefore(o)
                            .transition(A.label.transition, A.label.duration))
                        : (y.debug('Adding selection label', a),
                          a.insertBefore(o))))
                );
              },
              message: function(t) {
                ...
                if (!A.useLabels || !y.has.maxSelections()) {
                  ...
                  o
                    ? (n
                      ...
                      A.hideAdditions ||
                        ((t = A.templates.addition(
                          y.add.variables(k.addResult, e)
                        )),
                        n.html(t)),
                      y.verbose('Replacing user suggestion with new value', n))
                    : ((n = y.create.userChoice(e)),
                      n.prependTo(W),
                      y.verbose(
                    ...
                    (A.hideAdditions && !y.is.allFiltered()) ||
                      n
                        .addClass(T.selected)
                        .siblings()
                        .removeClass(T.selected),
              ...
              variables: function(e, t) {
                ...
                return (
                  ...
                  a &&
                    ((n = y.get.selectionCount()),
                    (e = e.replace('{count}', n))),
                  o &&
                    ((n = y.get.selectionCount()),
                    (e = e.replace('{maxCount}', A.maxSelections))),
                  s && ((i = t || y.get.query()), (e = e.replace('{term}', i))),
                  e
                );
              },
              value: function(t, n, i) {
                var a,
                  o = y.get.values();
                return '' === t
                  ? void y.debug('Cannot select blank values from multiselect')
                  : (e.isArray(o)
                      ? ((a = o.concat([t])), (a = y.get.uniqueArray(a)))
                      : (a = [t]),
                    y.has.selectInput()
                      ? y.can.extendSelect() &&
                        (y.debug('Adding value to select', t, a, N),
                        y.add.optionValue(t))
                      : ((a = a.join(A.delimiter)),
                        y.debug(
            ...
            remove: {
              ...
              filteredItem: function() {
                (A.useLabels && y.has.maxSelections()) ||
                  (A.useLabels && y.is.multiple()
                    ? $.not('.' + T.active).removeClass(T.filtered)
                    : $.removeClass(T.filtered),
                  y.remove.empty());
              },
              ...
              selected: function(t, n) {
                return (
                  ...
                  void n.each(function() {
                    ...
                    y.is.multiple()
                      ? A.useLabels
                        ? (y.remove.value(i, n, t), y.remove.label(i))
              ...
              value: function(e, t, n) {
                var i,
                  a = y.get.values();
                y.has.selectInput()
                  ? (y.verbose('Input is <select> removing selected option', e),
                  ...
                  A.fireOnInit === !1 && y.is.initialLoad()
                    ? y.verbose('No callback on initial load', A.onRemove)
                    : A.onRemove.call(J, e, t, n),
                  y.set.value(i, t, n),
                  y.check.maxSelections();
              },
                ...
                (t = t || z.find(O.label)),
                  ...
                  t.each(function() {
                    var t = e(this),
                      ...
                      a = n !== i ? String(n) : n,
                      o = y.is.userValue(a);
                    return A.onLabelRemove.call(t, n) === !1
                      ? void y.debug('Label remove callback cancelled removal')
                      : (y.remove.message(),
                        void (o
                          ? (y.remove.value(a), y.remove.label(a))
                          : y.remove.selected(a)));
                  });
              },
              tabbable: function() {
            ...
            has: {
              ...
              minCharacters: function(e) {
                return (
                  !A.minCharacters ||
                  ((e = e !== i ? String(e) : String(y.get.query())),
              ...
              maxSelections: function() {
                return (
                  A.maxSelections && y.get.selectionCount() >= A.maxSelections
                );
              },
            ...
            is: {
              ...
              allFiltered: function() {
                return (
                  ...
                  !(0 == A.hideAdditions && y.has.userSuggestion()) &&
                  !y.has.message() &&
                  y.has.allResultsFiltered()
                );
              },
              ...
              onScreen: function(e) {
                ...
                return (
                  ...
                  a.below
                    ? (y.verbose('Dropdown can fit in context downward', a),
                      (i = !0))
                    : a.below || a.above
                      ? (y.verbose(
            ...
            can: {
              activate: function(e) {
                return (
                  !!A.useLabels ||
                  (!y.has.maxSelections() ||
                    !(!y.has.maxSelections() || !e.hasClass(T.active)))
                );
              },
              click: function() {
                return c || 'click' == A.on;
            ...
            animate: {
              show: function(t, n) {
                ...
                (t = e.isFunction(t) ? t : function() {}),
                  ...
                  (y.is.hidden(o) || y.is.animating(o)) &&
                    ('none' == a
                      ? (s(), o.transition('show'), t.call(J))
                      : e.fn.transition !== i && z.transition('is supported')
                        ? o.transition({
                            animation: a + ' in',
                            debug: A.debug,
                            verbose: A.verbose,
              ...
              hide: function(t, n) {
                ...
                (t = e.isFunction(t) ? t : function() {}),
                  (y.is.visible(a) || y.is.animating(a)) &&
                    (y.verbose('Doing menu hide animation', a),
                    'none' == s
                      ? (o(), a.transition('hide'), t.call(J))
                      : e.fn.transition !== i && z.transition('is supported')
                        ? a.transition({
                            animation: s + ' out',
                            duration: A.duration,
            ...
            escape: {
              value: function(t) {
                var n = e.isArray(t),
                  ...
                  s = [];
                return y.has.selectInput() && !a && o
                  ? (y.debug('Encoding quote values for use in select', t),
                    n
                      ? (e.each(t, function(e, t) {
            ...
            setting: function(t, n) {
              if ((y.debug('Changing setting', t, n), e.isPlainObject(t)))
                e.extend(!0, A, t);
              else {
                if (n === i) return A[t];
            ...
            m
              ? (X === i && y.initialize(), y.invoke(v))
              : (X !== i && X.invoke('destroy'), y.initialize());
        }),
        o !== i ? o : s
      );
    }),
