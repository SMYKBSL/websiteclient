      ...
      return (
        r.each(function() {
          var t,
            ...
            p = r.selector || '',
            h = e.isPlainObject(a)
              ? e.extend(!0, {}, e.fn.shape.settings, a)
          ...
          (m = {
            initialize: function() {
              m.verbose('Initializing module for', H),
                m.set.defaultSide(),
                m.instantiate();
            },
            instantiate: function() {
              m.verbose('Storing instance of module', m), (T = m), C.data(w, T);
            },
            destroy: function() {
              m.verbose('Destroying previous module for', H),
                C.removeData(w).off(S);
            },
            refresh: function() {
              m.verbose('Refreshing selector cache for', H),
                (C = e(H)),
                (z = e(this).find(b.shape)),
                (W = e(this).find(b.side));
            },
            repaint: function() {
              m.verbose('Forcing repaint event');
              var e = z[0] || i.createElement('div');
              e.offsetWidth;
            },
                ...
                (i =
                  ...
                  function(e) {
                    m.verbose('Executing animation callback'),
                      e !== n && e.stopPropagation(),
                      m.reset(),
                      m.set.active();
                  }),
                h.beforeChange.call(f[0]),
                m.get.transitionEvent()
                  ? (m.verbose('Starting CSS animation'),
                    C.addClass(y.animating),
                    z.css(e).one(m.get.transitionEvent(), i),
                    m.set.duration(h.duration),
                    g(function() {
            ...
            queue: function(e) {
              m.debug('Queueing animation of', e),
                z.one(m.get.transitionEvent(), function() {
            ...
            set: {
              ...
              currentStageSize: function() {
                var e = C.find('.' + h.className.active),
                  t = e.outerWidth(!0),
                  i = e.outerHeight(!0);
                C.css({ width: t, height: i });
              },
              stageSize: function() {
                ...
                t.removeClass(y.active),
                  ...
                  e.remove(),
                  'auto' != h.width &&
                    (C.css('width', n + h.jitter),
                    m.verbose('Specifying width during animation', n)),
                  'auto' != h.height &&
                    (C.css('height', a + h.jitter),
                    m.verbose('Specifying height during animation', a));
              },
              nextSide: function(e) {
                (F = e),
                  (f = W.filter(e)),
                  (F = W.index(f)),
                  0 === f.length && (m.set.defaultSide(), m.error(x.side)),
            ...
            flip: {
              up: function() {
                if (m.is.complete() && !m.is.animating() && !h.allowRepeats)
                  return void m.debug('Side already visible', f);
              ...
              over: function() {
                return !m.is.complete() || m.is.animating() || h.allowRepeats
                  ? void (m.is.animating()
                      ? m.queue('flip over')
                  ...
                  : void m.debug('Side already visible', f);
              },
              back: function() {
                return !m.is.complete() || m.is.animating() || h.allowRepeats
                  ? void (m.is.animating()
            ...
            get: {
              transform: {
                ...
                over: function() {
                  var e = { x: -((t.outerWidth(!0) - f.outerWidth(!0)) / 2) };
                  return {
            ...
            stage: {
              above: function() {
                ...
                m.verbose(
                  ...
                  z.css({ transform: 'translateZ(-' + e.depth.active + 'px)' }),
                  t.css({
                    transform:
              ...
              left: function() {
                ...
                m.verbose(
                  ...
                  z.css({ transform: 'translateZ(-' + i.depth.active + 'px)' }),
                  t.css({
                    transform:
            ...
            setting: function(t, i) {
              if ((m.debug('Changing setting', t, i), e.isPlainObject(t)))
                ...
                if (i === n) return h[t];
                e.isPlainObject(h[t]) ? e.extend(!0, h[t], i) : (h[t] = i);
              }
            },
                    ...
                    var o =
                      i != r
                        ? a +
                          ...
                          t[i + 1].slice(1)
                        : t;
                    if (e.isPlainObject(l[o]) && i != r) l = l[o];
                    else {
                      if (l[o] !== n) return (s = l[o]), !1;
                      if (!e.isPlainObject(l[a]) || i == r)
                        return l[a] !== n && ((s = l[a]), !1);
                      l = l[a];
                    }
                  })),
                e.isFunction(s) ? (d = s.apply(a, i)) : s !== n && (d = s),
                e.isArray(o)
                  ? o.push(d)
                  : o !== n
                    ? (o = [o, d])
            ...
            u
              ? (T === n && m.initialize(), m.invoke(l))
              : (T !== n && T.invoke('destroy'), m.initialize());
        }),
        o !== n ? o : this
      );
    }),
