      ...
      return (
        a.each(function() {
          var d,
            g,
            f = e.isPlainObject(t)
              ? e.extend(!0, {}, e.fn.accordion.settings, t)
          ...
          (g = {
            ...
            open: function(n) {
              var t =
                ...
                r = s || a;
              return r
                ? void g.debug('Accordion already open, skipping', o)
                : (g.debug('Opening accordion content', t),
                  f.onOpening.call(o),
                  f.exclusive && g.closeOthers.call(t),
                  t.addClass(m.active),
                  o.stop(!0, !0).addClass(m.animating),
                  f.animateChildren &&
                    (e.fn.transition !== i && O.transition('is supported')
                      ? o
                          .children()
                          .transition({
                            animation: 'fade in',
                      ...
                      : o
                          .children()
                          .stop(!0, !0)
                          .animate({ opacity: 1 }, f.duration, g.resetOpacity)),
                  void o.slideDown(f.duration, f.easing, function() {
            ...
            close: function(n) {
              ...
              (!s && !r) ||
                c ||
                (g.debug('Closing accordion content', o),
                f.onClosing.call(o),
                ...
                f.animateChildren &&
                  (e.fn.transition !== i && O.transition('is supported')
                    ...
                    : o
                        .children()
                        .stop(!0, !0)
                        .animate({ opacity: 0 }, f.duration, g.resetOpacity)),
            ...
            closeOthers: function(n) {
              ...
              f.closeNested
                ...
                : ((t = c.find(l).not(r)),
                  ...
                  (a = t.next(F))),
                t.length > 0 &&
                  (g.debug('Exclusive enabled, closing other content', t),
                  t.removeClass(m.active),
                  a.removeClass(m.animating).stop(!0, !0),
                  f.animateChildren &&
                    (e.fn.transition !== i && O.transition('is supported')
                      ? a
                          .children()
            ...
            internal: function(n, t) {
              return (
                g.debug('Changing internal', n, t),
                t === i
                  ? g[n]
                  : void (e.isPlainObject(n) ? e.extend(!0, g, n) : (g[n] = t))
              );
            },
            debug: function() {
              !f.silent &&
                  ...
                  e.each(n, function(t, o) {
                    ...
                    if (e.isPlainObject(l[a]) && t != s) l = l[a];
                      ...
                      if (!e.isPlainObject(l[o]) || t == s)
                        return l[o] !== i
                          ? ((r = l[o]), !1)
                          : (g.error(v.method, n), !1);
                      l = l[o];
                    }
                  })),
                e.isFunction(r) ? (c = r.apply(a, t)) : r !== i && (c = r),
                e.isArray(o)
                  ? o.push(c)
                  : o !== i
                    ? (o = [o, c])
