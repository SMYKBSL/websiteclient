    ...
    (e.fn.checkbox = function(o) {
      ...
      return (
        c.each(function() {
          ...
          (h = {
            initialize: function() {
              h.verbose('Initializing checkbox', g),
                h.create.label(),
                h.bind.events(),
                h.set.tabbable(),
                h.hide.input(),
            ...
            setup: function() {
              h.set.initialLoad(),
                h.is.indeterminate()
                  ? (h.debug('Initial value is indeterminate'),
                    h.indeterminate())
                  : h.is.checked()
                    ? (h.debug('Initial value is checked'), h.check())
                    : (h.debug('Initial value is unchecked'), h.uncheck()),
            ...
            attachEvents: function(n, t) {
              var i = e(n);
              (t = e.isFunction(h[t]) ? h[t] : h.toggle),
                i.length > 0
                  ? (h.debug('Attaching checkbox events to element', n, t),
                    i.on('click' + v, t))
                  : h.error(m.notFound);
            },
            event: {
              ...
              keydown: function(e) {
                ...
                n == t.escape
                  ...
                  : e.ctrlKey || (n != t.space && n != t.enter)
                    ? (S = !1)
                    : (h.verbose('Enter/space key pressed, toggling checkbox'),
                      h.toggle(),
                      (S = !0));
              },
              keyup: function(e) {
            ...
            check: function() {
              h.should.allowCheck() &&
                (h.debug('Checking checkbox', w),
                h.set.checked(),
                h.should.ignoreCallbacks() ||
                  (g.onChecked.call(I), g.onChange.call(I)));
            },
            uncheck: function() {
              h.should.allowUncheck() &&
                (h.debug('Unchecking checkbox'),
                h.set.unchecked(),
                h.should.ignoreCallbacks() ||
                  (g.onUnchecked.call(I), g.onChange.call(I)));
            },
            indeterminate: function() {
              return h.should.allowIndeterminate()
                ? void h.debug('Checkbox is already indeterminate')
                : (h.debug('Making checkbox indeterminate'),
                  h.set.indeterminate(),
                  void (
                    h.should.ignoreCallbacks() ||
                    (g.onIndeterminate.call(I), g.onChange.call(I))
                  ));
            },
            determinate: function() {
              return h.should.allowDeterminate()
                ? void h.debug('Checkbox is already determinate')
                : (h.debug('Making checkbox determinate'),
                  h.set.determinate(),
                  void (
                    h.should.ignoreCallbacks() ||
                    (g.onDeterminate.call(I), g.onChange.call(I))
                  ));
            },
            enable: function() {
              return h.is.enabled()
                ? void h.debug('Checkbox is already enabled')
                : (h.debug('Enabling checkbox'),
                  h.set.enabled(),
                  g.onEnable.call(I),
                  void g.onEnabled.call(I));
            },
            disable: function() {
              return h.is.disabled()
                ? void h.debug('Checkbox is already disabled')
                : (h.debug('Disabling checkbox'),
                  h.set.disabled(),
                  g.onDisable.call(I),
                  void g.onDisabled.call(I));
            },
            get: {
              radios: function() {
                var n = h.get.name();
            ...
            should: {
              allowCheck: function() {
                return h.is.determinate() &&
                  h.is.checked() &&
                  !h.should.forceCallbacks()
                  ? (h.debug(
            ...
            set: {
              ...
              checked: function() {
                return (
                  ...
                  !h.is.indeterminate() && h.is.checked()
                    ...
                    : (h.verbose('Setting state to checked', I),
              ...
              unchecked: function() {
                return (
                  ...
                  !h.is.indeterminate() && h.is.unchecked()
                    ? void h.debug('Input is already unchecked')
                    : (h.debug('Setting state to unchecked'),
              ...
              indeterminate: function() {
                return (
                  ...
                  h.is.indeterminate()
                    ...
                    : (h.debug('Setting state to indeterminate'),
              ...
              determinate: function() {
                return (
                  ...
                  h.is.determinate()
                    ...
                    : (h.debug('Setting state to determinate'),
              ...
              disabled: function() {
                return (
                  ...
                  h.is.disabled()
                    ...
                    : (h.debug('Setting state to disabled'),
              ...
              enabled: function() {
                return (
                  ...
                  h.is.enabled()
                    ...
                    : (h.debug('Setting state to enabled'),
                      w.prop('disabled', !1),
                      void h.trigger.change())
                );
              },
            ...
            trigger: {
              change: function() {
                var e = t.createEvent('HTMLEvents'),
                  n = w[0];
                n &&
                  (h.verbose('Triggering native change event'),
            ...
            create: {
              label: function() {
                w.prevAll(k.label).length > 0
                  ? (w
                      .prev(k.label)
                      .detach()
                      .insertAfter(w),
                    h.debug('Moving existing label', x))
                  : h.has.label() ||
                    ((x = e('<label>').insertAfter(w)),
                    h.debug('Creating label', x));
              }
            },
            has: {
              label: function() {
            ...
            toggle: function() {
              return h.can.change()
                ? void (h.is.indeterminate() || h.is.unchecked()
                    ? (h.debug('Currently unchecked'), h.check())
                    : h.is.checked() &&
                      h.can.uncheck() &&
                      (h.debug('Currently checked'), h.uncheck()))
                : void (
                    h.is.radio() ||
                    h.debug(
            ...
            setting: function(n, t) {
              if ((h.debug('Changing setting', n, t), e.isPlainObject(n)))
                e.extend(!0, g, n);
              else {
                if (t === i) return g[n];
                ...
                'string' == typeof n &&
                  ...
                  e.each(n, function(t, o) {
                    var a =
                      t != c
                        ? o +
                          n[t + 1].charAt(0).toUpperCase() +
                          n[t + 1].slice(1)
                        : n;
                    if (e.isPlainObject(l[a]) && t != c) l = l[a];
                    else {
                      if (l[a] !== i) return (r = l[a]), !1;
                      if (!e.isPlainObject(l[o]) || t == c)
                        return l[o] !== i
                          ? ((r = l[o]), !1)
                          : (h.error(m.method, n), !1);
                      l = l[o];
                    }
                  })),
            ...
            u
              ? (E === i && h.initialize(), h.invoke(s))
              : (E !== i && E.invoke('destroy'), h.initialize());
        }),
        a !== i ? a : this
      );
    }),
