      ...
      return (
        a.each(function() {
          var a,
            ...
            C,
            T = t.isPlainObject(i)
              ? t.extend(!0, {}, t.fn.popup.settings, i)
              : t.extend({}, t.fn.popup.settings),
            P = T.selector,
            x = T.className,
            k = T.error,
            S = T.metadata,
          ...
          (C = {
            ...
            instantiate: function() {
              C.verbose('Storing instance', C), (I = C), O.data(D, I);
            },
            observeChanges: function() {
              'MutationObserver' in e &&
                ((b = new MutationObserver(C.event.documentChanged)),
                b.observe(o, { childList: !0, subtree: !0 }),
                C.debug('Setting up mutation observer', b));
            },
            refresh: function() {
              T.popup
                ? (a = t(T.popup).eq(0))
                : T.inline && ((a = H.nextAll(P.popup).eq(0)), (T.popup = a)),
                T.popup
                  ? (a.addClass(x.loading),
                    (v = C.get.offsetParent()),
                    a.removeClass(x.loading),
                    T.movePopup &&
                      C.has.popup() &&
                      C.get.offsetParent(a)[0] !== v[0] &&
                      (C.debug(
                        'Moving popup to the same offset parent as activating element'
                      ),
                      a.detach().appendTo(v)))
                  : (v = T.inline
                      ? C.get.offsetParent(H)
                      : C.has.popup()
                        ? C.get.offsetParent(a)
                        : l),
                v.is('html') &&
                  v[0] !== l[0] &&
                  (C.debug('Setting page as offset parent'), (v = l)),
            ...
            create: function() {
              ...
              e || n || o
                ? (C.debug('Creating pop-up html'),
                  e || (e = T.templates.popup({ title: o, content: n })),
                  (a = t('<div/>')
                    .addClass(x.popup)
                    .data(S.activator, O)
                    .html(e)),
                  T.inline
                    ? (C.verbose('Inserting popup element inline', a),
                      a.insertAfter(O))
                    : (C.verbose('Appending popup element to body', a),
                      a.appendTo(j)),
                  C.refresh(),
                  C.set.variation(),
                  T.hoverable && C.bind.popup(),
                  T.onCreate.call(a, G))
                : 0 !== H.next(P.popup).length
                  ? (C.verbose('Pre-existing popup found'),
                    ...
                    T.hoverable && C.bind.popup())
                  : T.popup
                    ? (t(T.popup).data(S.activator, O),
                      C.verbose('Used popup specified in settings'),
                      C.refresh(),
                      T.hoverable && C.bind.popup())
                    : C.debug('No content specified skipping display', G);
            },
            createID: function() {
            ...
            show: function(t) {
              if (
                ...
                if ((C.exists() || C.create(), T.onShow.call(a, G) === !1))
                  return void C.debug(
            ...
            hide: function(t) {
              if (
                ((t = t || function() {}), C.is.visible() || C.is.animating())
              ) {
            ...
            exists: function() {
              return (
                !!a &&
                (T.inline || T.popup ? C.has.popup() : a.closest(j).length >= 1)
              );
            },
            removePopup: function() {
              C.has.popup() &&
                !T.popup &&
                (C.debug('Removing popup', a),
                a.remove(),
                (a = n),
                T.onRemove.call(a, G));
            },
                  ...
                  O.transition('is supported')
                    ? (C.set.visible(),
                      a.transition({
                        ...
                        duration: T.duration,
                        onComplete: function() {
                          C.bind.close(), e.call(a, G), T.onVisible.call(a, G);
                        }
                      }))
                    ...
                    : void (T.transition &&
                      ...
                      O.transition('is supported')
                        ? a.transition({
                            ...
                            verbose: T.verbose,
                            onComplete: function() {
                              C.reset(), e.call(a, G), T.onHidden.call(a, G);
                            }
                          })
                        : C.error(k.noTransition))
                );
            ...
            get: {
              html: function() {
                return O.removeData(S.html), O.data(S.html) || T.html;
              },
              title: function() {
                return O.removeData(S.title), O.data(S.title) || T.title;
              },
              content: function() {
                return (
                  O.removeData(S.content),
                  O.data(S.content) || O.attr('title') || T.content
                );
              },
              variation: function() {
                return (
                  O.removeData(S.variation), O.data(S.variation) || T.variation
                );
              },
              popup: function() {
                return a;
              ...
              calculations: function() {
                var t,
                  ...
                  n = R[0] == e,
                  i =
                    T.inline || (T.popup && T.movePopup)
                      ? H.position()
                      : H.offset(),
                  r = n ? { top: 0, left: 0 } : R.offset(),
                  s = {},
                  l = n
                    ? { top: p.scrollTop(), left: p.scrollLeft() }
                    : { top: 0, left: 0 };
                return (
                  (s = {
                    target: {
                  ...
                  T.setFluidWidth &&
                    C.is.fluid() &&
                    ((s.container = { width: a.parent().outerWidth() }),
                    (s.popup.width = s.container.width)),
                  (s.target.margin.top = T.inline
                    ? parseInt(
                        e.getComputedStyle(o).getPropertyValue('margin-top'),
                        10
                      )
                    : 0),
                  (s.target.margin.left = T.inline
                    ? C.is.rtl()
                      ? parseInt(
                          e
                            .getComputedStyle(o)
                      ...
                      : parseInt(
                          e.getComputedStyle(o).getPropertyValue('margin-left'),
                          10
                        )
                    : 0),
                  (t = s.screen),
              ...
              nextPosition: function(t) {
                ...
                return (
                  ...
                  (l || p) && (C.debug('Using backup position', u), (u = a[t])),
                  u
                );
              }
            },
            set: {
              position: function(t, e) {
                ...
                if (
                  ...
                  return C.debug('Popup target is hidden, no action taken'), !1;
                switch (
                  (T.inline &&
                    (C.debug('Adding margin to calculation', r.margin),
                    'left center' == t || 'right center' == t
                      ? ((o += r.margin.top), (i += -r.margin.left))
                      : 'top left' == t || 'top center' == t || 'top right' == t
                        ? ((o += r.margin.left), (i -= r.margin.top))
                        : ((o += r.margin.left), (i += r.margin.top))),
                  C.debug('Determining popup position from calculations', t, e),
                  C.is.rtl() &&
                    ((t = t.replace(/left|right/g, function(t) {
                      return 'left' == t ? 'right' : 'left';
                    })),
                    C.debug('RTL: Popup position updated', t)),
                  N == T.maxSearchDepth &&
                    'string' == typeof T.lastResort &&
                    (t = T.lastResort),
                  t)
                ) {
                  case 'top left':
                ...
                if (
                  (l === n && C.error(k.invalidPosition, t),
                  C.debug('Calculated popup positioning values', l),
                  a
                    .css(l)
                    .removeClass(x.position)
                    .addClass(t)
                    .addClass(x.loading),
                  (u = C.get.popupOffset()),
                  ...
                  if (
                    (C.debug('Position is outside viewport', t),
                    N < T.maxSearchDepth)
                  )
                    return (
                      N++,
                  ...
                  if (!T.lastResort)
                    return (
                      C.debug('Popup could not find a position to display', a),
                ...
                return (
                  C.debug('Position is on stage', t),
                  C.remove.attempts(),
                  C.remove.loading(),
              ...
              variation: function(t) {
                (t = t || C.get.variation()),
                  t &&
                    C.has.popup() &&
                    (C.verbose('Adding variation to popup', t), a.addClass(t));
              },
              visible: function() {
            ...
            remove: {
              ...
              variation: function(t) {
                (t = t || C.get.variation()),
                  t && (C.verbose('Removing variation', t), a.removeClass(t));
              },
              visible: function() {
            ...
            bind: {
              events: function() {
                C.debug('Binding popup events to module'),
                  ...
                  'hover' == T.on &&
                    c &&
                    O.on('touchstart' + A, C.event.touchstart),
                  C.get.startEvent() &&
                    O.on(C.get.startEvent() + A, C.event.start).on(
                      C.get.endEvent() + A,
                      C.event.end
                    ),
              ...
              popup: function() {
                C.verbose('Allowing hover events on popup to prevent closing'),
                  a &&
                    C.has.popup() &&
                    a
                      .on('mouseenter' + A, C.event.start)
                      .on('mouseleave' + A, C.event.end);
              },
              close: function() {
                (T.hideOnScroll === !0 ||
                  ('auto' == T.hideOnScroll && 'click' != T.on)) &&
                  F.one(C.get.scrollEvent() + w, C.event.hideGracefully),
                  'hover' == T.on &&
                    W &&
            ...
            reset: function() {
              C.remove.visible(),
                T.preserve
                  ? t.fn.transition !== n && a.transition('remove transition')
                  : C.removePopup();
            },
            ...
            h
              ? (I === n && C.initialize(), C.invoke(g))
              : (I !== n && I.invoke('destroy'), C.initialize());
        }),
        r !== n ? r : this
      );
    }),
