          ...
          (C = {
            ...
            delay: function(n) {
              ...
              r || (r = C.can.transition() ? C.get.direction() : 'static'),
                ...
                (a =
                  i || 1 == f.reverse
                    ? (o.length - e) * f.interval
                    : e * f.interval),
                C.debug('Delaying animation by', a),
                setTimeout(C.animate, a);
            },
            animate: function(n) {
              if (((f = n || f), !C.is.supported()))
                return C.error(g.support), !1;
              if (
                (C.debug('Preparing animation', f.animation), C.is.animating())
              ) {
                if (f.queue)
                  return (
                    !f.allowRepeats &&
              ...
              C.can.animate()
                ...
                : C.error(g.noAnimation, f.animation, S);
            },
            reset: function() {
            ...
            force: {
              visible: function() {
                var n = A.attr('style'),
                  ...
                  r = n === t || '' === n;
                o !== i
                  ? (C.verbose('Overriding default display to show element', i),
                    A.attr('style', a))
            ...
            set: {
              ...
              duration: function(n, e) {
                (e = e || f.duration),
                  ...
                  (e || 0 === e) &&
                    (C.verbose('Setting animation duration', e),
                    A.css({ 'animation-duration': e }));
              },
            ...
            remove: {
              ...
              looping: function() {
                C.debug('Transitions are no longer looping'),
                  C.is.looping() && (C.reset(), A.removeClass(v.looping));
              },
              transition: function() {
            ...
            get: {
                ...
                return 'object' == typeof e
                  ...
                  : 'function' == typeof t
                    ...
                    : 'string' == typeof i || 'number' == typeof i
                      ...
                      : 'object' == typeof i
                        ? n.extend({}, n.fn.transition.settings, i, {
                            animation: e
                          })
                        : 'function' == typeof i
                          ? n.extend({}, n.fn.transition.settings, {
              ...
              currentAnimation: function() {
                return (
                  !(!C.cache || C.cache.animation === t) && C.cache.animation
                );
              },
              ...
              displayType: function(n) {
                return (
                  ...
                  f.displayType
                    ? f.displayType
                    : (n && A.data(b.displayType) === t && C.can.transition(!0),
                      A.data(b.displayType))
                );
              },
              userStyle: function(n) {
                return (
                  (n = n || A.attr('style') || ''), n.replace(/display.*?;/, '')
                );
              },
              ...
              transition: function(e) {
                ...
                if (d === t || e) {
                  if (
                    ...
                    (r = o
                      .addClass(u)
                      .removeClass(v.inward)
                      .removeClass(v.outward)
                    ...
                    C.debug('Direction exists for animation', u), (l = !0);
                  else {
                    if ('none' == r || !r)
                      return void C.debug('No animation defined in css', u);
                    C.debug('Static animation found', u, c), (l = !1);
                  }
            ...
            setting: function(e, i) {
              if ((C.debug('Changing setting', e, i), n.isPlainObject(e)))
                n.extend(!0, f, e);
              else {
                if (i === t) return f[e];
