          ...
          return (
            ...
            'string' == typeof t &&
              ...
              e.each(t, function(n, o) {
                var r =
                  n != s
                    ? o + t[n + 1].charAt(0).toUpperCase() + t[n + 1].slice(1)
                    : t;
          ...
          a.each(function() {
            ...
            (F = {
              initialize: function() {
                F.get.settings(),
                  d
                    ? (P === i && F.instantiate(), F.invoke(c))
                    : (P !== i && P.invoke('destroy'),
              ...
              destroy: function() {
                F.verbose('Destroying previous module', P),
                  F.removeEvents(),
                  O.removeData(R);
              },
              refresh: function() {
              ...
              attachEvents: function(t, n) {
                (n = n || 'submit'),
                  e(t).on('click' + E, function(e) {
                    F[n](), e.preventDefault();
                  });
              },
              bindEvents: function() {
                F.verbose('Attaching form events'),
                  O.on('submit' + E, F.validate.form)
                    .on('blur' + E, k.field, F.event.field.blur)
                    .on('click' + E, k.submit, F.submit)
                    .on('click' + E, k.reset, F.reset)
                    .on('click' + E, k.clear, F.clear),
                  x.keyboardShortcuts &&
                    O.on('keydown' + E, k.field, F.event.field.keydown),
                  m.each(function() {
                    var t = e(this),
                      n = t.prop('type'),
              ...
              clear: function() {
                m.each(function() {
                  ...
                  l &&
                    (F.verbose('Resetting error on field', i),
                    i.removeClass(S.error),
                    o.remove()),
                    s
                      ? (F.verbose('Resetting dropdown value', n, a),
                        n.dropdown('clear'))
                      : r
                        ? t.prop('checked', !1)
                        : (F.verbose('Resetting field value', t, a), t.val(''));
                });
              },
              reset: function() {
                m.each(function() {
                  ...
                  r !== i &&
                    (c &&
                      (F.verbose('Resetting error on field', o),
                      o.removeClass(S.error),
                      a.remove()),
                    l
                      ? (F.verbose('Resetting dropdown value', n, r),
                        n.dropdown('restore defaults'))
                      : s
                        ? (F.verbose('Resetting checkbox value', n, r),
                          t.prop('checked', r))
                        : (F.verbose('Resetting field value', t, r), t.val(r)));
                });
              },
              is: {
                ...
                valid: function() {
                  var t = !0;
                  return (
                    F.verbose('Checking if form is valid'),
              ...
              event: {
                field: {
                  keydown: function(t) {
                    ...
                    i == s.escape &&
                      ...
                      t.ctrlKey ||
                        ...
                        a ||
                        (j ||
                          (n.one('keyup' + E, F.event.field.keyup),
                          F.submit(),
                  ...
                  blur: function(t) {
                    ...
                    i.hasClass(S.error)
                      ? (F.debug('Revalidating field', n, o),
                        o && F.validate.field(o))
                  ...
                  change: function(t) {
                    var n = e(this),
                      ...
                      o = F.get.validation(n);
                    ('change' == x.on ||
                      (i.hasClass(S.error) && x.revalidate)) &&
              ...
              get: {
                ancillaryValue: function(e) {
                  return (
                    !(!e.type || (!e.value && !F.is.bracketedRule(e))) &&
                    (e.value !== i
                      ? e.value
                ...
                prompt: function(e, t) {
                  var n,
                    ...
                    c = s.search('{name}') !== -1;
                  return (
                    (c || l) && (i = F.get.field(t.identifier)),
                ...
                field: function(t) {
                  return (
                    F.verbose('Finding field with identifier', t),
                    m.filter('#' + t).length > 0
                      ? m.filter('#' + t)
              ...
              remove: {
                prompt: function(t) {
                  ...
                  o.removeClass(S.error),
                    x.inline &&
                      a.is(':visible') &&
                      (F.verbose('Removing prompt for field', t),
                      x.transition &&
                      e.fn.transition !== i &&
                      O.transition('is supported')
                        ? a.transition(
                ...
                values: function(t) {
                  e.isEmptyObject(t) ||
                    e.each(t, function(t, n) {
                      ...
                      u &&
                        (r && s
                          ? (F.verbose('Selecting multiple', n, o),
                            a.checkbox('uncheck'),
                          ...
                          : c
                            ? (F.verbose('Selecting radio value', n, o),
                              o
                                .filter('[value="' + n + '"]')
                                .parent(k.uiCheckbox)
                                .checkbox('check'))
                            : s
                              ? (F.verbose('Setting checkbox value', n, a),
                                n === !0
                                  ? a.checkbox('check')
                                  : a.checkbox('uncheck'))
                              : l
                                ? (F.verbose('Setting dropdown value', n, a),
                                  a.dropdown('set selected', n))
                                : (F.verbose('Setting field value', n, o),
                                  o.val(n)));
                    });
                }
              },
              validate: {
                form: function(e, t) {
                  ...
                  if (((q = []), F.is.valid())) {
                    if (
                      (F.debug('Form has no validation errors, submitting'),
                      F.set.success(),
                      t !== !0)
                    )
                      return x.onSuccess.call(D, e, n);
                  } else if (
                    (F.debug('Form has errors'),
                    F.set.error(),
                ...
                field: function(t, n) {
                  ...
                  return (
                    t.identifier ||
                      (F.debug('Using field name as identifier', o),
                      (t.identifier = o)),
                    a.prop('disabled')
                      ? (F.debug('Field is disabled. Skipping', o), (s = !0))
                      : t.optional && F.is.blank(a)
                        ? (F.debug('Field is optional and blank. Skipping', o),
                          (s = !0))
                        : t.depends && F.is.empty(r)
                          ? (F.debug(
                          ...
                          : t.rules !== i &&
                            e.each(t.rules, function(e, n) {
                              F.has.field(o) &&
                                !F.validate.rule(t, n) &&
                                (F.debug('Field is invalid', o, n.type),
                                l.push(F.get.prompt(n, t)),
                                (s = !1));
                            }),
                    s
                      ? (F.remove.prompt(o, l), x.onValid.call(a), !0)
                      : ((q = q.concat(l)),
                        F.add.prompt(o, l),
      ...
      (e.fn.form.settings = {
        ...
        rules: {
          ...
          maxCount: function(e, t) {
            return (
              0 != t &&
              (1 == t ? e.search(',') === -1 : e.split(',').length <= t)
            );
          }
        }
      });
            ...
            (f = {
              ...
              observeChanges: function() {
                'MutationObserver' in t &&
                  ...
                  d.observe(S, { childList: !0, subtree: !0 }),
              ...
              c
                ? (T === i && f.initialize(), f.invoke(l))
                : (T !== i && T.invoke('destroy'), f.initialize());
          }),
          o !== i ? o : this
        );
      }),
            ...
            (m = {
                ...
                m.set.initialLoad(),
                  m.is.indeterminate()
                    ...
                    : m.is.checked()
                      ...
                      : (m.debug('Initial value is unchecked'), m.uncheck()),
              ...
              attachEvents: function(t, n) {
                ...
                (n = e.isFunction(m[n]) ? m[n] : m.toggle),
                  i.length > 0
                    ? (m.debug('Attaching checkbox events to element', t, n),
                      i.on('click' + y, n))
                    : m.error(b.notFound);
              },
              event: {
                click: function(t) {
                  ...
                  return n.is(v.input)
                    ...
                    : n.is(v.link)
                      ...
                      : (m.toggle(), k.focus(), void t.preventDefault());
                },
                keydown: function(e) {
                  var t = e.which,
              ...
              check: function() {
                m.should.allowCheck() &&
                  (m.debug('Checking checkbox', k),
                  m.set.checked(),
                  m.should.ignoreCallbacks() ||
                    (g.onChecked.call(S), g.onChange.call(S)));
              },
              uncheck: function() {
                m.should.allowUncheck() &&
                  ...
                  m.set.unchecked(),
                  m.should.ignoreCallbacks() ||
                    (g.onUnchecked.call(S), g.onChange.call(S)));
              },
              indeterminate: function() {
                return m.should.allowIndeterminate()
                  ? void m.debug('Checkbox is already indeterminate')
                  : (m.debug('Making checkbox indeterminate'),
                    m.set.indeterminate(),
                    void (
                      m.should.ignoreCallbacks() ||
                      (g.onIndeterminate.call(S), g.onChange.call(S))
                    ));
              },
              determinate: function() {
                return m.should.allowDeterminate()
                  ? void m.debug('Checkbox is already determinate')
                  : (m.debug('Making checkbox determinate'),
                    m.set.determinate(),
                    void (
                      m.should.ignoreCallbacks() ||
                      (g.onDeterminate.call(S), g.onChange.call(S))
                    ));
              },
              enable: function() {
                return m.is.enabled()
                  ? void m.debug('Checkbox is already enabled')
              ...
              disable: function() {
                return m.is.disabled()
                  ? void m.debug('Checkbox is already disabled')
              ...
              is: {
                ...
                indeterminate: function() {
                  return (
                    k.prop('indeterminate') !== i && k.prop('indeterminate')
                  );
                },
                checked: function() {
                ...
                allowIndeterminate: function() {
                  return m.is.indeterminate() && !m.should.forceCallbacks()
                    ? (m.debug(
                      ...
                      !1)
                    : g.beforeIndeterminate.apply(S) !== !1 ||
                        (m.debug(
              ...
              can: {
                change: function() {
                  return !(
                    ...
                    C.hasClass(p.readOnly) ||
                    k.prop('disabled') ||
                    k.prop('readonly')
                  );
                },
                uncheck: function() {
                  return 'boolean' == typeof g.uncheckable
                    ? g.uncheckable
                    : !m.is.radio();
                }
              },
                ...
                checked: function() {
                  return (
                    ...
                    !m.is.indeterminate() && m.is.checked()
                      ...
                      : (m.verbose('Setting state to checked', S),
                ...
                unchecked: function() {
                  return (
                    ...
                    !m.is.indeterminate() && m.is.unchecked()
                      ? void m.debug('Input is already unchecked')
              ...
              create: {
                label: function() {
                  k.prevAll(v.label).length > 0
                    ? (k
                        .prev(v.label)
                        .detach()
                        .insertAfter(k),
                      m.debug('Moving existing label', w))
                    : m.has.label() ||
                      ((w = e('<label>').insertAfter(k)),
              ...
              bind: {
                events: function() {
                  m.verbose('Attaching checkbox events'),
                    C.on('click' + y, m.event.click)
                      .on('keydown' + y, v.input, m.event.keydown)
                      .on('keyup' + y, v.input, m.event.keyup);
                }
              },
              unbind: {
                events: function() {
              ...
              toggle: function() {
                return m.can.change()
                  ? void (m.is.indeterminate() || m.is.unchecked()
              ...
              d
                ? (R === i && m.initialize(), m.invoke(u))
                : (R !== i && R.invoke('destroy'), m.initialize());
          }),
          a !== i ? a : this
        );
      }),
            ...
            (m = {
              ...
              bind: {
                events: function() {
                  'hover' == g.on
                    ? f
                        .on('mouseenter' + y, m.show)
                        .on('mouseleave' + y, m.hide)
              ...
              show: function(t) {
                (t = e.isFunction(t) ? t : function() {}),
                  ...
                  (m.is.dimmed() && !m.is.animating()) || !m.is.enabled()
                    ...
                    : (m.animate.show(t), g.onShow.call(S), g.onChange.call(S));
              },
              hide: function(t) {
                (t = e.isFunction(t) ? t : function() {}),
              ...
              m.preinitialize(),
              c
                ? (T === i && m.initialize(), m.invoke(l))
                : (T !== i && T.invoke('destroy'), m.initialize());
          }),
          o !== i ? o : this
        );
      }),
        ...
        return (
          r.each(function(p) {
            ...
            (k = {
              ...
              observeChanges: function() {
                'MutationObserver' in t &&
                  ((C = new MutationObserver(k.event.select.mutation)),
              ...
              observe: {
                ...
                menu: function() {
                  k.has.menu() &&
                    w.observe(Q[0], { childList: !0, subtree: !0 });
                }
              },
              create: {
                id: function() {
                ...
                userChoice: function(t) {
                  ...
                  return (
                    ...
                    e.each(t, function(t, r) {
                      k.get.item(r) === !1 &&
                        ((a = S.templates.addition(
                          k.add.variables(A.addResult, r)
                        )),
                        (o = e('<div />')
                          .html(a)
                          .attr('data-' + P.value, r)
              ...
              select: {
                firstUnfiltered: function() {
                  k.verbose('Selecting first non-filtered element'),
                    ...
                    X.not(D.unselectable)
                      .not(D.addition + D.hidden)
                      .eq(0)
                      .addClass(T.selected);
                },
                nextAvailable: function(e) {
                  ...
                  i
                    ...
                    : (k.verbose('Moving selection to', n),
              ...
              setup: {
                api: function() {
                  var e = {
                    debug: S.debug,
                    urlData: { value: k.get.value(), query: k.get.query() },
                    on: !1
                  };
                  ...
                  k.debug('Dropdown initialized on a select', t),
                    ...
                    U.parent(D.dropdown).length > 0
                      ? (k.debug(
                        ...
                        (Q = I.children(D.menu)),
                        k.setup.menu(t))
                      : (k.debug('Creating entire dropdown from select'),
                        (I = e('<div />')
                          .attr('class', U.attr('class'))
                          .addClass(T.selection)
                          .addClass(T.dropdown)
                          .html(j.dropdown(t))
                          .insertBefore(U)),
                        U.hasClass(T.multiple) &&
                          U.prop('multiple') === !1 &&
                          (k.error(q.missingMultiple), U.prop('multiple', !0)),
              ...
              refreshData: function() {
                k.verbose('Refreshing cached metadata'),
                  X.removeData(P.text).removeData(P.value);
              },
              clearData: function() {
                k.verbose('Clearing metadata'),
                  X.removeData(P.text).removeData(P.value),
                  I.removeData(P.defaultText)
              ...
              bind: {
                ...
                touchEvents: function() {
                  k.debug(
                    ...
                    k.is.searchSelection() ||
                      (k.is.single() &&
                        I.on('touchstart' + z, k.event.test.toggle)),
                ...
                keyboardEvents: function() {
                  k.verbose('Binding keyboard events'),
                    ...
                    k.has.search() &&
                      I.on(k.get.inputEvent() + z, D.search, k.event.input),
                    k.is.multiple() &&
                      s.on('keydown' + y, k.event.document.keydown);
                },
                ...
                mouseEvents: function() {
                  k.verbose('Binding mouse events'),
                    k.is.multiple() &&
                      I.on('click' + z, D.label, k.event.label.click).on(
                        'click' + z,
                        D.remove,
                        k.event.remove.click
                      ),
                    k.is.searchSelection()
                      ? (I.on('mousedown' + z, k.event.mousedown)
                          .on('mouseup' + z, k.event.mouseup)
                          .on('mousedown' + z, D.menu, k.event.menu.mousedown)
                          .on('mouseup' + z, D.menu, k.event.menu.mouseup)
                          .on('click' + z, D.icon, k.event.icon.click)
                          .on('focus' + z, D.search, k.event.search.focus)
                          .on('click' + z, D.search, k.event.search.focus)
                          .on('blur' + z, D.search, k.event.search.blur)
                          .on('click' + z, D.text, k.event.text.focus),
                        k.is.multiple() && I.on('click' + z, k.event.click))
                      : ('click' == S.on
                          ? I.on('click' + z, D.icon, k.event.icon.click).on(
                              'click' + z,
                              k.event.test.toggle
                            )
                          : 'hover' == S.on
                            ? I.on('mouseenter' + z, k.delay.show).on(
                                'mouseleave' + z,
                                k.delay.hide
                              )
                            : I.on(S.on + z, k.toggle),
                        I.on('mousedown' + z, k.event.mousedown)
                          .on('mouseup' + z, k.event.mouseup)
                          .on('focus' + z, k.event.focus)
                          .on('blur' + z, k.event.blur)),
                    Q.on('mouseenter' + z, D.item, k.event.item.mouseenter)
                      .on('mouseleave' + z, D.item, k.event.item.mouseleave)
                      .on('click' + z, D.item, k.event.item.click);
                },
                intent: function() {
                  k.verbose('Binding hide intent event to document'),
                    c &&
                      s
                        .on('touchstart' + y, k.event.test.touch)
                        .on('touchmove' + y, k.event.test.touch),
              ...
              filter: function(e) {
                ...
                (S.useLabels && k.has.maxSelections()) ||
                  (S.apiSettings
                    ? k.can.useAPI()
              ...
              queryRemote: function(t, n) {
                var i = {
                  ...
                  onSuccess: function(e) {
                    k.remove.message(),
                      k.setup.menu({ values: e[R.remoteValues] }),
                      n();
                  }
                };
                ...
                k.has.query() &&
                  ...
                  X.each(function() {
                    ...
                    if ('both' == S.match || 'value' == S.match) {
                      if (
                        ((i = String(k.get.choiceValue(a, t))),
                        i.search(r) !== -1)
                      )
                        return o.push(this), !0;
              ...
              focusSearch: function(e) {
                k.has.search() &&
                  !k.is.focusedOnSearch() &&
                  (e
                    ? (I.off('focus' + z, D.search),
                      V.focus(),
                      I.on('focus' + z, D.search, k.event.search.focus))
                    : V.focus());
              },
              forceSelection: function() {
                var e = X.not(T.filtered)
                    .filter('.' + T.selected)
                    .eq(0),
                  t = X.not(T.filtered)
                    .filter('.' + T.active)
                  ...
                  i = n.length > 0;
                return i
                  ? (k.debug('Forcing partial selection to selected item', n),
                    void k.event.item.click.call(n, {}, !0))
                  : void (S.allowAdditions
                      ? (k.set.selected(k.get.query()), k.remove.searchTerm())
                      : k.remove.searchTerm());
              },
              event: {
                change: function() {
                ...
                click: function(t) {
                  var n = e(t.target);
                  n.is(I) &&
                    (k.is.focusedOnSearch() ? k.show() : k.focusSearch());
                },
                search: {
                  focus: function() {
                    ($ = !0),
                  ...
                  blur: function(e) {
                    (v = n.activeElement === this),
                      b ||
                        Y ||
                        v ||
                        (S.forceSelection && k.forceSelection(), k.hide()),
                      (b = !1);
                  }
                },
                icon: {
                ...
                test: {
                  toggle: function(e) {
                    ...
                    k.is.bubbledLabelClick(e) ||
                      k.is.bubbledIconClick(e) ||
                      (k.determine.eventOnElement(e, t) && e.preventDefault());
                  },
                  touch: function(e) {
                    k.determine.eventOnElement(e, function() {
                      'touchstart' == e.type
                        ...
                        : 'touchmove' == e.type && clearTimeout(k.timer);
                    }),
                      e.stopPropagation();
                  },
                  hide: function(e) {
                ...
                item: {
                  ...
                  click: function(t, n) {
                    var i = e(this),
                      ...
                      c = a.find(o).length > 0;
                    c ||
                      (l && !S.allowCategorySelection) ||
                      (k.is.searchSelection() &&
                        (S.allowAdditions && k.remove.userAddition(),
                        k.remove.searchTerm(),
                        k.is.focusedOnSearch() || 1 == n || k.focusSearch(!0)),
                      S.useLabels ||
                        (k.remove.filteredItem(), k.set.scrollPosition(i)),
                    ...
                    if (n) {
                      ...
                      t == E.leftArrow
                        ? (!m && !g) || s
                          ? s &&
                            (e.shiftKey
                              ? k.verbose('Adding previous label to selection')
                            ...
                            e.preventDefault())
                          : (k.verbose('Selecting previous label'),
                            i.last().addClass(T.active))
                        : t == E.rightArrow
                          ? (m && !s && i.first().addClass(T.active),
                            s &&
                              (e.shiftKey
                                ? k.verbose('Adding next label to selection')
                              ...
                              u
                                ? d
                                  ? f
                                    ...
                                    : k.focusSearch()
                                  : l
                                    ? o.next(D.siblingLabel).addClass(T.active)
                                    : o.addClass(T.active)
                                : o.next(D.siblingLabel).addClass(T.active),
                              e.preventDefault()))
                ...
                keydown: function(e) {
                  ...
                  if (n) {
                    var i,
                      ...
                      l =
                        s.length > 0
                          ? s.siblings(':not(.' + T.filtered + ')').addBack()
                          : Q.children(':not(.' + T.filtered + ')'),
                      c = s.children(D.menu),
                      u = s.closest(D.menu),
                      d =
                        u.hasClass(T.visible) ||
                        u.hasClass(T.animating) ||
                        u.parent(D.menu).length > 0,
                      f = c.length > 0,
                      m = s.length > 0,
                      g = s.not(D.unselectable).length > 0,
                      p =
                        t == E.delimiter && S.allowAdditions && k.is.multiple(),
                      h =
                        S.allowAdditions &&
                        S.hideAdditions &&
                        (t == E.enter || p) &&
                    ...
                    if (
                      (h &&
                        (k.verbose('Selecting item from keyboard shortcut', s),
                      ...
                      if (
                        ((t == E.enter || p) &&
                          (t == E.enter && m && f && !S.allowCategorySelection
                            ? (k.verbose(
                        ...
                        m &&
                          (t == E.leftArrow &&
                            ((o = u[0] !== Q[0]),
                            o &&
                              (k.verbose('Left key pressed, closing sub-menu'),
                              k.animate.hide(!1, u),
                          ...
                          t == E.rightArrow &&
                            f &&
                            (k.verbose('Right key pressed, opening sub-menu'),
                            k.animate.show(!1, c),
                            s.removeClass(T.selected),
                            c
                              .find(D.item)
                      ...
                      t == E.pageUp && (k.scrollPage('up'), e.preventDefault()),
                        t == E.pageDown &&
                          (k.scrollPage('down'), e.preventDefault()),
                        t == E.escape &&
                          (k.verbose('Escape key pressed, closing dropdown'),
                          k.hide());
                    } else
                      p && e.preventDefault(),
                        t != E.downArrow ||
                          k.is.visible() ||
                          (k.verbose('Down key pressed, showing dropdown'),
                          k.select.firstUnfiltered(),
                          k.show(),
                          e.preventDefault());
                  } else
              ...
              determine: {
                selectAction: function(t, n) {
                  k.verbose('Determining action', S.action),
                    e.isFunction(k.action[S.action])
                      ? (k.verbose('Triggering preset action', S.action, t, n),
                        k.action[S.action].call(Z, t, n, this))
                      : e.isFunction(S.action)
                        ? (k.verbose('Triggering user action', S.action, t, n),
                          S.action.call(Z, t, n, this))
                        : k.error(q.action, S.action);
                },
                eventInModule: function(t, i) {
                  ...
                  return (
                    ...
                    a && !r
                      ? (k.verbose('Triggering event', i), i(), !0)
                      : (k.verbose(
              ...
              get: {
                ...
                choiceText: function(t, n) {
                  if (((n = n !== i ? n : S.preserveHTML), t))
                    return (
                      t.find(D.menu).length > 0 &&
                        (k.verbose('Retrieving text of element with sub-menu'),
                        (t = t.clone()),
                ...
                selectValues: function() {
                  ...
                  return (
                    ...
                    I.find('option').each(function() {
                      ...
                      'auto' === S.placeholder && '' === r
                        ? (t.placeholder = o)
                        : t.values.push({ name: o, value: r, disabled: a });
                    }),
                    S.placeholder &&
                      'auto' !== S.placeholder &&
                      (k.debug('Setting placeholder value to', S.placeholder),
                      (t.placeholder = S.placeholder)),
                    S.sortSelect
                      ? (t.values.sort(function(e, t) {
                          return e.name > t.name ? 1 : -1;
                        }),
                        k.debug('Retrieved and sorted values from select', t))
                      ...
                      X.each(function() {
                        ...
                        if (null !== l && l !== i)
                          if (a)
                            ...
                            return (
                              k.verbose('Found select item by value', l, t),
                              (r = o),
                              !0
                            );
                      }),
              ...
              check: {
                maxSelections: function(e) {
                  return (
                    !S.maxSelections ||
                    ((e = e !== i ? e : k.get.selectionCount()),
                    e >= S.maxSelections
                      ? (k.debug('Maximum selection count reached'),
                        S.useLabels &&
                          (X.addClass(T.filtered),
                          k.add.message(A.maxSelections)),
                        !0)
                      : (k.verbose('No longer at maximum selection count'),
                        k.remove.message(),
                        k.remove.filteredItem(),
              ...
              restore: {
                ...
                defaultText: function() {
                  ...
                  e === t
                    ...
                    : (k.debug('Restoring default text', e), k.set.text(e));
                },
                placeholderText: function() {
                ...
                labels: function() {
                  S.allowAdditions &&
                    (S.useLabels || (k.error(q.labels), (S.useLabels = !0)),
                ...
                values: function() {
                  k.set.initialLoad(),
                    S.apiSettings && S.saveRemoteData && k.get.remoteValues()
              ...
              read: {
                remoteData: function(e) {
                  var n;
                  return t.Storage === i
                    ? void k.error(q.noStorage)
                    : ((n = sessionStorage.getItem(e)), n !== i && n);
                }
              },
              save: {
                defaults: function() {
                ...
                defaultValue: function() {
                  ...
                  k.verbose('Saving default value as', e),
                    I.data(P.defaultValue, e);
                },
                defaultText: function() {
                  var e = k.get.text();
                  k.verbose('Saving default text as', e),
                    I.data(P.defaultText, e);
                },
                placeholderText: function() {
                  var e;
                  S.placeholder !== !1 &&
                    ...
                    I.data(P.placeholderText, e));
                },
                remoteData: function(e, n) {
                  return t.Storage === i
                    ? void k.error(q.noStorage)
                    : (k.verbose('Saving remote data to session storage', n, e),
                      void sessionStorage.setItem(n, e));
                }
              },
              clear: function() {
                k.is.multiple() && S.useLabels
                  ? k.remove.labels()
                  : (k.remove.activeItem(), k.remove.selectedItem()),
                  k.set.placeholderText(),
                  k.clearValue();
              ...
              scrollPage: function(e, t) {
                var n,
                  i,
                  o,
                  a = t || k.get.selectedItem(),
                  r = a.closest(D.menu),
                  s = r.outerHeight(),
                  l = r.scrollTop(),
                  c = X.eq(0).outerHeight(),
                  u = Math.floor(s / c),
                  d = (r.prop('scrollHeight'),
                  'up' == e ? l - c * u : l + c * u),
              ...
              set: {
                filtered: function() {
                  ...
                  e &&
                    o &&
                    (k.verbose('Adjusting input width', a, S.glyphWidth),
                    V.css('width', a)),
                    o || (n && r)
                ...
                tabbable: function() {
                  k.has.search()
                    ...
                    : (k.debug('Added tabindex to dropdown'),
                      I.attr('tabindex') === i &&
                        (I.attr('tabindex', 0), Q.attr('tabindex', -1)));
                },
                initialLoad: function() {
                  k.verbose('Setting initial load'), (h = !0);
                },
                activeItem: function(e) {
                  S.allowAdditions && e.filter(D.addition).length > 0
                ...
                text: function(e) {
                  'select' !== S.action &&
                    ('combo' == S.action
                      ? (k.debug('Changing combo button text', e, B),
                        S.preserveHTML ? B.html(e) : B.text(e))
                ...
                selectedLetter: function(t) {
                  ...
                  o &&
                    ...
                    a &&
                      (k.verbose('Scrolling to next value with letter', t),
                      k.set.scrollPosition(a),
                      i.removeClass(T.selected),
                      a.addClass(T.selected),
                      S.selectOnKeydown &&
                        k.is.single() &&
                        k.set.selectedItem(a));
                },
                direction: function(e) {
                  'auto' == S.direction
                    ? k.is.onScreen(e)
                      ? k.remove.upward(e)
                      : k.set.upward(e)
                    : 'upward' == S.direction && k.set.upward(e);
                },
                upward: function(e) {
                  var t = e || I;
                  t.addClass(T.upward);
                ...
                value: function(e, t, n) {
                  ...
                  if (a) {
                    ...
                    k.is.single() &&
                      k.has.selectInput() &&
                      k.can.extendSelect() &&
                      (k.debug('Adding user option', e), k.add.optionValue(e)),
                      k.debug('Updating input value', o, r),
                      (K = !0),
                      U.val(o),
                      S.fireOnInit === !1 && k.is.initialLoad()
                        ? k.debug(
                    ...
                    k.verbose('Storing value in metadata', o, U),
                      o !== r && I.data(P.value, s);
                  S.fireOnInit === !1 && k.is.initialLoad()
                    ? k.verbose('No callback on initial load', S.onChange)
                    : S.onChange.call(Z, e, t, n);
                },
                active: function() {
                  I.addClass(T.active);
                },
                ...
                selected: function(t, n) {
                  var i = k.is.multiple();
                  (n = S.allowAdditions
                    ? n || k.get.itemWithAdditions(t)
                    : n || k.get.item(t)),
                    n &&
                      (k.debug('Setting selected menu item to', n),
                      k.is.multiple() && k.remove.searchWidth(),
                      k.is.single()
                        ? (k.remove.activeItem(), k.remove.selectedItem())
                        : S.useLabels && k.remove.selectedItem(),
                      n.each(function() {
                        var t = e(this),
                        ...
                        i
                          ? !s || l
                            ? (S.apiSettings &&
                                S.saveRemoteData &&
                                k.save.remoteData(o, a),
                              S.useLabels
                                ? (k.add.value(a, o, t),
                                  k.add.label(a, o, c),
                                  k.set.activeItem(t),
                                  k.filterActive(),
                                  k.select.nextAvailable(n))
                                : (k.add.value(a, o, t),
                                  k.set.text(k.add.variables(A.count)),
                                  k.set.activeItem(t)))
                            : r ||
                              (k.debug('Selected active value, removing label'),
                              k.remove.selected(a))
                          : (S.apiSettings &&
                              S.saveRemoteData &&
                              k.save.remoteData(o, a),
              ...
              add: {
                label: function(t, n, i) {
                  ...
                  return (
                    ...
                    k.has.label(t)
                      ? void k.debug('Label already exists, skipping', r)
                      : (S.label.variation && o.addClass(S.label.variation),
                        void (i === !0
                          ? (k.debug('Animating in label', o),
                            o
                              .addClass(T.hidden)
                              .insertBefore(a)
                              .transition(S.label.transition, S.label.duration))
                          : (k.debug('Adding selection label', o),
                            o.insertBefore(a))))
                  );
                },
                message: function(t) {
                  ...
                  if (!S.useLabels || !k.has.maxSelections()) {
                    ...
                    a
                      ? (n
                        ...
                        S.hideAdditions ||
                          ((t = S.templates.addition(
                            k.add.variables(A.addResult, e)
                          )),
                          n.html(t)),
                        k.verbose(
                      ...
                      (S.hideAdditions && !k.is.allFiltered()) ||
                        n
                          .addClass(T.selected)
                          .siblings()
                ...
                variables: function(e, t) {
                  var n,
                    ...
                    r = e.search('{term}') !== -1;
                  return (
                    k.verbose('Adding templated variables to message', e),
                    o &&
                      ((n = k.get.selectionCount()),
                      (e = e.replace('{count}', n))),
                    a &&
                      ((n = k.get.selectionCount()),
                      (e = e.replace('{maxCount}', S.maxSelections))),
                    r &&
                      ((i = t || k.get.query()), (e = e.replace('{term}', i))),
                    e
                  );
                },
                value: function(t, n, i) {
                  ...
                  return '' === t
                    ...
                    : (e.isArray(a)
                        ? ((o = a.concat([t])), (o = k.get.uniqueArray(o)))
                        : (o = [t]),
                      k.has.selectInput()
                        ? k.can.extendSelect() &&
                          (k.debug('Adding value to select', t, o, U),
                          k.add.optionValue(t))
                        : ((o = o.join(S.delimiter)),
                          k.debug(
              ...
              remove: {
                ...
                filteredItem: function() {
                  (S.useLabels && k.has.maxSelections()) ||
                    (S.useLabels && k.is.multiple()
                      ? X.not('.' + T.active).removeClass(T.filtered)
                      : X.removeClass(T.filtered),
                    k.remove.empty());
                },
                ...
                selected: function(t, n) {
                  return (
                    ...
                    void n.each(function() {
                      ...
                      k.is.multiple()
                        ? S.useLabels
                          ? (k.remove.value(i, n, t), k.remove.label(i))
                ...
                value: function(e, t, n) {
                  ...
                  k.has.selectInput()
                    ...
                    S.fireOnInit === !1 && k.is.initialLoad()
                      ? k.verbose('No callback on initial load', S.onRemove)
                      : S.onRemove.call(Z, e, t, n),
                    k.set.value(i, t, n),
                    k.check.maxSelections();
                },
                  ...
                  (t = t || I.find(D.label)),
                    ...
                    t.each(function() {
                      var t = e(this),
                        ...
                        o = n !== i ? String(n) : n,
                        a = k.is.userValue(o);
                      return S.onLabelRemove.call(t, n) === !1
                        ? void k.debug(
                            'Label remove callback cancelled removal'
                          )
                        : (k.remove.message(),
                          void (a
                            ? (k.remove.value(o), k.remove.label(o))
                            : k.remove.selected(o)));
                    });
                },
                tabbable: function() {
              ...
              has: {
                ...
                minCharacters: function(e) {
                  return (
                    !S.minCharacters ||
                    ((e = e !== i ? String(e) : String(k.get.query())),
                    e.length >= S.minCharacters)
                  );
                },
                ...
                maxSelections: function() {
                  return (
                    S.maxSelections && k.get.selectionCount() >= S.maxSelections
                  );
                },
              ...
              is: {
                ...
                allFiltered: function() {
                  return (
                    ...
                    !(0 == S.hideAdditions && k.has.userSuggestion()) &&
                    !k.has.message() &&
                    k.has.allResultsFiltered()
                  );
                },
                ...
                onScreen: function(e) {
                  ...
                  return (
                    ...
                    o.below
                      ? (k.verbose('Dropdown can fit in context downward', o),
                        (i = !0))
                      : o.below || o.above
                        ? (k.verbose(
              ...
              can: {
                activate: function(e) {
                  return (
                    !!S.useLabels ||
                    (!k.has.maxSelections() ||
                      !(!k.has.maxSelections() || !e.hasClass(T.active)))
                  );
                },
                click: function() {
                  return c || 'click' == S.on;
              ...
              animate: {
                show: function(t, n) {
                  ...
                  (t = e.isFunction(t) ? t : function() {}),
                    ...
                    (k.is.hidden(a) || k.is.animating(a)) &&
                      ('none' == o
                        ? (r(), a.transition('show'), t.call(Z))
                ...
                hide: function(t, n) {
                  ...
                  (t = e.isFunction(t) ? t : function() {}),
                    (k.is.visible(o) || k.is.animating(o)) &&
                      (k.verbose('Doing menu hide animation', o),
                      'none' == r
                        ? (a(), o.transition('hide'), t.call(Z))
                        : e.fn.transition !== i && I.transition('is supported')
                          ? o.transition({
                              animation: r + ' out',
                              duration: S.duration,
              ...
              escape: {
                value: function(t) {
                  var n = e.isArray(t),
                    ...
                    r = [];
                  return k.has.selectInput() && !o && a
                    ? (k.debug('Encoding quote values for use in select', t),
                      n
                        ? (e.each(t, function(e, t) {
              ...
              m
                ? (J === i && k.initialize(), k.invoke(f))
                : (J !== i && J.invoke('destroy'), k.initialize());
          }),
          a !== i ? a : r
        );
      }),
        ...
        return (
          a.each(function() {
            ...
            (f = {
              ...
              u
                ? (E === i && f.initialize(), f.invoke(c))
                : (E !== i && E.invoke('destroy'), f.initialize());
          }),
          o !== i ? o : this
        );
      }),
        ...
        return (
          r.each(function() {
            ...
            (S = {
              ...
              instantiate: function() {
                S.verbose('Storing instance of modal'), (M = S), D.data(O, M);
              },
              create: {
                dimmer: function() {
                  var t = {
                    ...
                    T.inverted &&
                      (n.variation =
                        n.variation !== i
                          ...
                          : 'inverted'),
                    e.fn.dimmer === i
                      ? void S.error(P.dimmer)
                      : (S.debug('Creating dimmer with settings', n),
                        (y = q.dimmer(n)),
                        T.detachable
                          ? (S.verbose(
                              'Modal is detachable, moving content into dimmer'
                            ),
                            y.dimmer('add content', D))
                          : S.set.undetached(),
              ...
              observeChanges: function() {
                'MutationObserver' in t &&
                  ...
                  k.observe(z, { childList: !0, subtree: !0 }),
              ...
              attachEvents: function(t, n) {
                ...
                (n = e.isFunction(S[n]) ? S[n] : S.toggle),
                  i.length > 0
                    ? (S.debug('Attaching modal events to element', t, n),
                      i.off(F).on('click' + F, n))
                    : S.error(P.notFound, t);
              },
              bind: {
                events: function() {
                  S.verbose('Attaching events'),
                    D.on('click' + F, A.close, S.event.close)
                      .on('click' + F, A.approve, S.event.approve)
                      .on('click' + F, A.deny, S.event.deny),
              ...
              event: {
                approve: function() {
                  return T.onApprove.call(z, e(this)) === !1
                    ? void S.verbose(
                ...
                deny: function() {
                  return T.onDeny.call(z, e(this)) === !1
                    ? void S.verbose(
                ...
                click: function(t) {
                  ...
                  !o &&
                    a &&
                    (S.debug('Dimmer clicked, hiding all modals'),
                    S.is.active() &&
                      (S.remove.clickaway(),
                ...
                keyboard: function(e) {
                  ...
                  t == n &&
                    (T.closable
                      ? (S.debug('Escape key pressed hiding modal'), S.hide())
                      : S.debug(
                ...
                (t = e.isFunction(t) ? t : function() {}),
                  S.is.animating() || !S.is.active()
                    ? (S.showDimmer(),
                      ...
                      S.set.type(),
                      S.set.clickaway(),
                      !T.allowMultiple && S.others.active()
                        ? S.hideOthers(S.showModal)
                        : (T.onShow.call(z),
                          T.transition &&
                          e.fn.transition !== i &&
                          D.transition('is supported')
                            ? (S.debug('Showing modal with css animations'),
                              D.transition({
                                debug: T.debug,
              ...
              showDimmer: function() {
                y.dimmer('is animating') || !y.dimmer('is active')
                  ? (S.debug('Showing dimmer'), y.dimmer('show'))
                  : S.debug('Dimmer already visible');
              },
              hideDimmer: function() {
              ...
              hideAll: function(t) {
                ...
                (t = e.isFunction(t) ? t : function() {}),
                  n.length > 0 &&
                    (S.debug('Hiding all visible modals'),
                    S.hideDimmer(),
              ...
              remove: {
                ...
                bodyStyle: function() {
                  '' === c.attr('style') &&
                    (S.verbose('Removing style attribute'),
                    c.removeAttr('style'));
                },
              ...
              cacheSizes: function() {
                ...
                (S.cache !== i && 0 === o) ||
                  (S.cache = {
                    ...
                    height: o + T.offset,
                    contextHeight:
                      'body' == T.context ? e(t).height() : y.height()
                  }),
              ...
              is: {
                ...
                animating: function() {
                  return D.transition('is supported')
                    ? D.transition('is animating')
                    : D.is(':visible');
                },
                scrolling: function() {
              ...
              set: {
                ...
                type: function() {
                  S.can.fit()
                    ? (S.verbose('Modal fits on screen'),
                      S.others.active() ||
                        S.others.animating() ||
                        S.remove.scrolling())
                    : (S.verbose(
                ...
                position: function() {
                  S.verbose('Centering modal on page', S.cache),
                    S.can.fit()
                      ? D.css({ top: '', marginTop: -(S.cache.height / 2) })
              ...
              setting: function(t, n) {
                if ((S.debug('Changing setting', t, n), e.isPlainObject(t)))
                  e.extend(!0, T, t);
                else {
                  if (n === i) return T[t];
              ...
              g
                ? (M === i && S.initialize(), S.invoke(m))
                : (M !== i && M.invoke('destroy'), S.initialize());
          }),
          a !== i ? a : this
        );
      }),
            ...
            (C = {
              initialize: function() {
                C.debug('Initializing', F),
                  ...
                  w.observeChanges && C.observeChanges(),
                  C.instantiate();
              },
              instantiate: function() {
              ...
              observeChanges: function() {
                'MutationObserver' in t &&
                  ((b = new MutationObserver(C.event.documentChanged)),
                  b.observe(n, { childList: !0, subtree: !0 }),
                  C.debug('Setting up mutation observer', b));
              },
              refresh: function() {
                w.popup
                  ? (r = e(w.popup).eq(0))
                  : w.inline && ((r = j.nextAll(k.popup).eq(0)), (w.popup = r)),
                  w.popup
                    ? (r.addClass(S.loading),
                      ...
                      w.movePopup &&
                        C.has.popup() &&
                        C.get.offsetParent(r)[0] !== v[0] &&
                        (C.debug(
                          'Moving popup to the same offset parent as activating element'
                        ),
                        r.detach().appendTo(v)))
                    : (v = w.inline
                        ? C.get.offsetParent(j)
                        : C.has.popup()
                          ? C.get.offsetParent(r)
                          : c),
                  v.is('html') &&
                    v[0] !== c[0] &&
                    (C.debug('Setting page as offset parent'), (v = c)),
              ...
              event: {
                ...
                hideGracefully: function(t) {
                  ...
                  t && !a && o
                    ? (C.debug('Click occurred outside popup hiding popup'),
                      C.hide())
                    : C.debug('Click was inside popup, keeping popup open');
                }
              },
              create: function() {
                var t = C.get.html(),
                  ...
                  i = C.get.content();
                t || i || n
                  ? (C.debug('Creating pop-up html'),
                    t || (t = w.templates.popup({ title: n, content: i })),
                    (r = e('<div/>')
                      .addClass(S.popup)
                      .data(A.activator, F)
                      .html(t)),
                    w.inline
                      ? (C.verbose('Inserting popup element inline', r),
                        r.insertAfter(F))
                      : (C.verbose('Appending popup element to body', r),
                        r.appendTo(O)),
                    C.refresh(),
                    C.set.variation(),
                  ...
                  : 0 !== j.next(k.popup).length
                    ? (C.verbose('Pre-existing popup found'),
                      (w.inline = !0),
                      (w.popup = j.next(k.popup).data(A.activator, F)),
                      C.refresh(),
                      w.hoverable && C.bind.popup())
                    : w.popup
                      ? (e(w.popup).data(A.activator, F),
                        C.verbose('Used popup specified in settings'),
                        C.refresh(),
                        w.hoverable && C.bind.popup())
                      : C.debug('No content specified skipping display', L);
              },
              createID: function() {
                (x = (Math.random().toString(16) + '000000000').substr(2, 8)),
                  (y = '.' + x),
              ...
              toggle: function() {
                C.debug('Toggling pop-up'),
                  C.is.hidden()
                    ? (C.debug('Popup is hidden, showing pop-up'),
                      C.unbind.close(),
                      C.show())
                    : (C.debug('Popup is visible, hiding pop-up'), C.hide());
              },
              show: function(e) {
                if (
                  ((e = e || function() {}),
                  ...
                  if ((C.exists() || C.create(), w.onShow.call(r, L) === !1))
                    return void C.debug(
              ...
              hide: function(e) {
                if (
                  ((e = e || function() {}), C.is.visible() || C.is.animating())
                ) {
              ...
              exists: function() {
                return (
                  ...
                  (w.inline || w.popup
                    ? C.has.popup()
                    : r.closest(O).length >= 1)
                );
              },
              removePopup: function() {
                C.has.popup() &&
                  !w.popup &&
                  (C.debug('Removing popup', r),
                  r.remove(),
                  (r = i),
                  w.onRemove.call(r, L));
              },
              ...
              get: {
                ...
                content: function() {
                  return (
                    F.removeData(A.content),
                    F.data(A.content) || F.attr('title') || w.content
                  );
                },
                variation: function() {
                  return (
                    F.removeData(A.variation),
                ...
                calculations: function() {
                  ...
                  return (
                    ...
                    (s.target.margin.top = w.inline
                      ? parseInt(
                          t.getComputedStyle(n).getPropertyValue('margin-top'),
                          10
                        )
                      : 0),
                ...
                nextPosition: function(e) {
                  ...
                  return (
                    M ||
                      (C.verbose('All available positions available'),
                      (M = C.get.positions())),
                    ...
                    (c || l) &&
                      (C.debug('Using backup position', u), (u = r[e])),
                    u
                  );
                }
              },
              set: {
                position: function(e, t) {
                  ...
                  if (
                    ...
                    return (
                      C.debug('Popup target is hidden, no action taken'), !1
                    );
                  switch (
                    (w.inline &&
                      (C.debug('Adding margin to calculation', a.margin),
                      'left center' == e || 'right center' == e
                        ? ((n += a.margin.top), (o += -a.margin.left))
                        : 'top left' == e ||
                          'top center' == e ||
                          'top right' == e
                          ? ((n += a.margin.left), (o -= a.margin.top))
                          : ((n += a.margin.left), (o += a.margin.top))),
                    C.debug(
                  ...
                  if (
                    (c === i && C.error(T.invalidPosition, e),
                    C.debug('Calculated popup positioning values', c),
                    r
                      .css(c)
                      .removeClass(S.position)
                      .addClass(e)
                      .addClass(S.loading),
                    (u = C.get.popupOffset()),
                    ...
                    if (
                      (C.debug('Position is outside viewport', e),
                      z < w.maxSearchDepth)
                    )
                      return (
                        z++,
                  ...
                  return (
                    C.debug('Position is on stage', e),
                    C.remove.attempts(),
                    C.remove.loading(),
                ...
                variation: function(e) {
                  (e = e || C.get.variation()),
                    e &&
                      C.has.popup() &&
                      (C.verbose('Adding variation to popup', e),
                      r.addClass(e));
                },
                visible: function() {
              ...
              remove: {
                ...
                variation: function(e) {
                  (e = e || C.get.variation()),
                    e && (C.verbose('Removing variation', e), r.removeClass(e));
                },
                visible: function() {
              ...
              bind: {
                events: function() {
                  C.debug('Binding popup events to module'),
                    'click' == w.on && F.on('click' + E, C.toggle),
                    'hover' == w.on &&
                      d &&
                      F.on('touchstart' + E, C.event.touchstart),
                    C.get.startEvent() &&
                      F.on(C.get.startEvent() + E, C.event.start).on(
                        C.get.endEvent() + E,
                        C.event.end
                      ),
                ...
                popup: function() {
                  C.verbose(
                    ...
                    r &&
                      C.has.popup() &&
                      r
                        .on('mouseenter' + E, C.event.start)
                        .on('mouseleave' + E, C.event.end);
                },
                close: function() {
                  (w.hideOnScroll === !0 ||
                    ('auto' == w.hideOnScroll && 'click' != w.on)) &&
                    D.one(C.get.scrollEvent() + y, C.event.hideGracefully),
                    'hover' == w.on &&
                      I &&
                      (C.verbose('Binding popup close event to document'),
              ...
              reset: function() {
                C.remove.visible(),
                  w.preserve
                    ? e.fn.transition !== i && r.transition('remove transition')
                    : C.removePopup();
              },
              setting: function(t, n) {
              ...
              p
                ? (N === i && C.initialize(), C.invoke(g))
                : (N !== i && N.invoke('destroy'), C.initialize());
          }),
          a !== i ? a : this
        );
      }),
      ...
      return (
        a.each(function() {
          ...
          (f = {
            ...
            complete: function() {
              (f.percent === i || f.percent < 100) &&
                (f.remove.progressPoll(), f.set.percent(100));
            },
            read: {
              metadata: function() {
                var e = {
            ...
            get: {
              ...
              normalizedValue: function(e) {
                ...
                if (f.has.total()) {
                  if (e > f.total)
                    return (
                      f.debug('Value cannot increment above total', f.total),
                      f.total
                    );
                } else if (e > 100)
                  return (
                    f.debug('Value cannot increment above 100 percent'), 100
                  );
                return e;
              },
            ...
            remove: {
              progressPoll: function() {
                f.verbose('Removing progress poll timer'),
                  f.progressPoll &&
                    (clearTimeout(f.progressPoll), delete f.progressPoll);
              },
              nextValue: function() {
            ...
            set: {
              ...
              percent: function(e) {
                (e = 'string' == typeof e ? +e.replace('%', '') : e),
                  ...
                  f.has.total() ||
                    ((f.value =
                      m.precision > 0
                        ? Math.round((e / 100) * f.total * (10 * m.precision)) /
                          (10 * m.precision)
              ...
              state: function(e) {
                (e = e !== i ? e : f.percent),
                  100 === e
                    ? m.autoSuccess &&
                      !(f.is.warning() || f.is.error() || f.is.success())
                      ? (f.set.success(),
              ...
              barLabel: function(e) {
                e !== i
                  ...
                  : 'ratio' == m.label && f.total
                    ? (f.verbose('Adding ratio to bar label'),
                      k.text(f.get.text(m.text.ratio)))
                    : 'percent' == m.label &&
                      (f.verbose('Adding percentage to bar label'),
              ...
              success: function(e) {
                (e = e || m.text.success || m.text.active),
                  ...
                  f.complete(),
                  m.text.success
                    ? ((e = m.onLabelUpdate('success', e, f.value, f.total)),
                      f.set.label(e))
                    : ((e = m.onLabelUpdate('active', e, f.value, f.total)),
                      f.set.label(e)),
                  f.bind.transitionEnd(function() {
            ...
            (f = {
              ...
              bind: {
                events: function() {
                  f.verbose('Binding events'),
                    w
                      .on('mouseenter' + b, v.icon, f.event.mouseenter)
                      .on('mouseleave' + b, v.icon, f.event.mouseleave)
                      .on('click' + b, v.icon, f.event.click);
                }
              },
              remove: {
                events: function() {
              ...
              get: {
                initialRating: function() {
                  return w.data(h.rating) !== i
                    ? (w.removeData(h.rating), w.data(h.rating))
                    : m.initialRating;
                },
                maxRating: function() {
                  return w.data(h.maxRating) !== i
                    ? (w.removeData(h.maxRating), w.data(h.maxRating))
                    : m.maxRating;
                },
                rating: function() {
              ...
              set: {
                rating: function(e) {
                  ...
                  w.removeClass(p.selected),
                    ...
                    e > 0 &&
                      (f.verbose('Setting current rating to', e),
                      n
                        .prevAll()
                        .addBack()
                        .addClass(p.active)),
              ...
              c
                ? (C === i && f.initialize(), f.invoke(l))
                : (C !== i && C.invoke('destroy'), f.initialize());
          }),
          n !== i ? n : this
        );
      }),
        ...
        return (
          e(this).each(function() {
            ...
            (m = {
              ...
              bind: {
                events: function() {
                  m.verbose('Binding events to search'),
                    g.automatic &&
                      (S.on(m.get.inputEvent() + w, y.prompt, m.event.input),
                      T.attr('autocomplete', 'off')),
                    S.on('focus' + w, y.prompt, m.event.focus)
                ...
                cache: function(e) {
                  ...
                  e
                    ? e &&
                      ...
                      delete t[e],
                      S.data(h.cache, t))
                    : (m.debug('Clearing cache', e), S.removeData(h.cache));
                }
              },
              read: {
                cache: function(e) {
              ...
              d
                ? (O === i && m.initialize(), m.invoke(u))
                : (O !== i && O.invoke('destroy'), m.initialize());
          }),
          a !== i ? a : this
        );
      }),
        ...
        return (
          r.each(function() {
            ...
            (g = {
              ...
              set: {
                ...
                stageSize: function() {
                  ...
                  t.removeClass(x.active),
                    ...
                    e.remove(),
                    'auto' != h.width &&
                      (k.css('width', i + h.jitter),
                      g.verbose('Specifying width during animation', i)),
                    'auto' != h.height &&
                      (k.css('height', o + h.jitter),
              ...
              flip: {
                up: function() {
                  if (g.is.complete() && !g.is.animating() && !h.allowRepeats)
                    return void g.debug('Side already visible', m);
              ...
              u
                ? (E === i && g.initialize(), g.invoke(c))
                : (E !== i && E.invoke('destroy'), g.initialize());
          }),
          a !== i ? a : this
        );
      }),
        ...
        return (
          r.each(function() {
            ...
            (w = {
              ...
              event: {
                ...
                containScroll: function(e) {
                  M.scrollTop <= 0 && (M.scrollTop = 1),
                    M.scrollTop + M.offsetHeight >= M.scrollHeight &&
                      (M.scrollTop = M.scrollHeight - M.offsetHeight - 1);
                },
                scroll: function(t) {
                  0 === e(t.target).closest(S.sidebar).length &&
                    t.preventDefault();
                }
              },
              bind: {
                clickaway: function() {
                  w.verbose('Adding clickaway events to context', D),
                    k.closable &&
                      D.on('click' + b, w.event.clickaway).on(
                        'touchend' + b,
                        w.event.clickaway
                      );
                },
                scrollLock: function() {
                  k.scrollLock &&
                    ...
                    O.on('scroll' + P, w.event.containScroll);
                }
              },
              unbind: {
                clickaway: function() {
              ...
              repaint: function() {
                w.verbose('Forcing repaint event'), (M.style.display = 'none');
                M.offsetHeight;
                ...
                layout: function() {
                  0 === D.children(S.pusher).length &&
                    ...
                    D.children()
                      ...
                      .wrapAll(z),
                    w.refresh()),
                    (0 !== O.nextAll(S.pusher).length &&
                      O.nextAll(S.pusher)[0] === z[0]) ||
                      (w.debug('Moved sidebar to correct parent element'),
                      w.error(E.movedSidebar, M),
              ...
              show: function(t) {
                if (
                  ...
                  if (
                    (w.refreshSidebars(),
                    k.overlay &&
                      (w.error(E.overlay), (k.transition = 'overlay')),
                    w.refresh(),
                    w.othersActive())
                  )
                    if (
              ...
              is: {
                ...
                rtl: function() {
                  return (
                    w.cache.rtl === i &&
                      (w.cache.rtl = 'rtl' == O.css('direction')),
                    w.cache.rtl
                  );
                }
              },
              ...
              p
                ? (I === i && w.initialize(), w.invoke(g))
                : (I !== i && w.invoke('destroy'), w.initialize());
          }),
          a !== i ? a : this
        );
      }),
          ...
          r.each(function() {
            ...
            (h = {
              ...
              determineContext: function() {
                if (((m = v.context ? e(v.context) : r), 0 === m.length))
                  return void h.error(x.invalidContext, v.context, k);
              },
              checkErrors: function() {
                if (
                  (h.is.hidden() && h.error(x.visible, k),
                  h.cache.element.height > h.cache.context.height)
                )
                  return h.reset(), void h.error(x.elementSize, k);
              },
              bind: {
                events: function() {
                  S.on('load' + C, h.event.load).on(
                    'resize' + C,
                    h.event.resize
                  ),
                    T.off('scroll' + C)
                      .on('scroll' + C, h.event.scroll)
                      .on('scrollchange' + C, h.event.scrollchange);
                }
              },
              event: {
                changed: function(e) {
              ...
              supports: {
                sticky: function() {
                  ...
                  t[0];
                  return (
                    t.addClass(b.supported), t.css('position').match('sticky')
                  );
                }
              },
              save: {
              ...
              set: {
                ...
                containerSize: function() {
                  ...
                  'HTML' === e || 'body' == e
                    ? h.determineContainer()
                    : Math.abs(r.outerHeight() - h.cache.context.height) >
                        v.jitter &&
                      (h.debug(
                        'Context has padding, specifying exact height for container',
                        h.cache.context.height
                      ),
                      r.css({ height: h.cache.context.height }));
                },
                ...
                scroll: function(e) {
                  h.debug('Setting scroll on element', e),
                    h.elementScroll != e &&
                      (h.is.top() && k.css('bottom', '').css('top', -e),
                      h.is.bottom() && k.css('top', '').css('bottom', e));
                },
                size: function() {
                  0 !== h.cache.element.height &&
                    0 !== h.cache.element.width &&
                    (E.style.setProperty(
                      'width',
                      h.cache.element.width + 'px',
                      'important'
                    ),
                    E.style.setProperty(
                      'height',
                      h.cache.element.height + 'px',
                      'important'
                    ));
                }
              },
                  ...
                  (h.is.initialPosition()
                    ? e.top >= r.bottom
                      ? (h.debug(
                        ...
                        h.bindBottom())
                      : e.top > o.top &&
                        (o.height + e.top - l >= r.bottom
                          ? (h.debug(
                              'Initial element position is bottom of container'
                            ),
                            h.bindBottom())
                          : (h.debug('Initial element position is fixed'),
                            h.fixTop()))
                    : h.is.fixed()
                      ? h.is.top()
                        ? e.top <= o.top
                          ? (h.debug('Fixed element reached top of container'),
                            h.setInitialPosition())
                          : o.height + e.top - l >= r.bottom
                            ? (h.debug(
              ...
              unbind: function() {
                h.is.bound() &&
                  (h.debug('Removing container bound position on element'),
                  h.remove.offset(),
                  k
                    .removeClass(b.bound)
                    .removeClass(b.top)
              ...
              unfix: function() {
                h.is.fixed() &&
                  (h.debug('Removing fixed position on element'),
                  h.remove.offset(),
                  k
                    .removeClass(b.fixed)
                    .removeClass(b.top)
              ...
              d
                ? (A === i && h.initialize(), h.invoke(u))
                : (A !== i && A.invoke('destroy'), h.initialize());
          }),
          a !== i ? a : this
        );
      }),
          ...
          r.each(function() {
            ...
            (b = {
              ...
              bind: {
                events: function() {
                  e.isWindow(O) ||
                    (b.debug('Attaching tab activation events to element', R),
                ...
                (n = b.utilities.arrayToPath(r)),
                  e.each(r, function(t, i) {
                    ...
                    if ((b.verbose('Looking for tab', i), m)) {
                      ...
                      if (n.search('/') != -1 || '' === n)
                        return b.error(S.missingTab, R, g, f), !1;
                      if (
                        ((s = e('#' + n + ', a[name="' + n + '"]')),
                    ...
                    'string' != typeof n
                      ...
                      : o
                        ? (b.debug(
                          ...
                          a.html(n))
                        : (b.debug('Updating HTML', t, n), (r.innerHTML = n));
                }
              },
              fetch: {
              ...
              get: {
                ...
                defaultPath: function(e) {
                  var t = r.filter('[data-' + w.tab + '^="' + e + '/"]').eq(0),
                    n = t.data(w.tab) || !1;
                  if (n) {
                    if ((b.debug('Found default tab', n), F < x.maxDepth))
                      return F++, b.get.defaultPath(n);
                    b.error(S.recursion);
              ...
              d
                ? (D === i && b.initialize(), b.invoke(u))
                : (D !== i && D.invoke('destroy'), b.initialize());
          }),
          a !== i ? a : this
        );
      }),
          ...
          a.each(function(t) {
            ...
            (C = {
              ...
              animate: function(e) {
                ...
                if (
                  (C.debug('Preparing animation', m.animation),
                  C.is.animating())
                ) {
                  if (m.queue)
                    return (
              ...
              get: {
                ...
                currentAnimation: function() {
                  return (
                    !(!C.cache || C.cache.animation === i) && C.cache.animation
                  );
                },
        ...
        a.each(function() {
          ...
          (h = {
              ...
              events: function() {
                ...
                e
                  ? (h.verbose('Attaching API events to element', e),
                    T.on(e + k, h.event.trigger))
                  : 'now' == v.on &&
                    (h.debug('Querying API endpoint immediately'), h.query());
              }
            },
            decode: {
              json: function(e) {
            ...
            query: function() {
              ...
              return (
                v.defaultData && e.extend(!0, v.urlData, h.get.defaultData()),
            ...
            should: {
              removeError: function() {
                return (
                  v.hideError === !0 || ('auto' === v.hideError && !h.is.form())
                );
              }
            },
            is: {
              ...
              validResponse: function(t) {
                return h.is.expectingJSON() && e.isFunction(v.successTest)
                  ? (h.debug(
                            ...
                            e.isPlainObject(n) && n[r] !== i
                              ...
                              : T.data(r) !== i
                                ...
                                : R.data(r) !== i
                                  ...
                                  : n[r];
                        return s === i
                          ? (h.error(C.requiredParameter, r, t), (t = !1), !1)
              ...
              request: function() {
                h.set.loading(),
                  ...
                  h.is.mocked()
                    ...
                    : (h.xhr = h.create.xhr()),
                  v.onRequest.call(P, h.request, h.xhr);
              }
            },
            event: {
              trigger: function(e) {
              ...
              xhr: {
                always: function() {},
                  ...
                  var o = this,
                    ...
                    s =
                      !!e.isFunction(v.onResponse) &&
                      (h.is.expectingJSON()
                        ? v.onResponse.call(o, e.extend(!0, {}, t))
                        : v.onResponse.call(o, t));
                  (r = r > 0 ? r : 0),
                    s &&
                      (h.debug(
            ...
            create: {
              ...
              mockedXHR: function() {
                ...
                return (
                  ...
                  s
                    ? (e.isFunction(s)
                        ? (h.debug('Using specified synchronous callback', s),
                          (n = s.call(P, f)))
                        : (h.debug('Using settings specified response', s),
                          (n = s)),
                      i.resolveWith(P, [n, o, { responseText: n }]))
                    : e.isFunction(l) &&
                      ((t = function(e) {
                        h.debug('Async callback returned response', e),
                          e
                            ? i.resolveWith(P, [e, o, { responseText: e }])
                            : i.rejectWith(P, [{ responseText: e }, a, r]);
                      }),
            ...
            get: {
              ...
              urlEncodedValue: function(e) {
                ...
                return o
                  ? (h.debug(
                    ...
                    e)
                  : (h.verbose('Encoding value using encodeURIComponent', e, i),
                    i);
              },
              defaultData: function() {
                ...
                return (
                  e.isWindow(E) ||
                    (h.is.input()
                      ? (t.value = T.val())
                      : h.is.form() || (t.text = T.text())),
                  t
                );
              },
              event: function() {
                return e.isWindow(E) || 'now' == v.on
                  ? (h.debug('API called without element, no events attached'),
                    !1)
                  : 'auto' == v.on
                    ? T.is('input')
                      ? E.oninput !== i
              ...
              templatedURL: function(e) {
                if (
                  ((e = e || T.data(y.action) || v.action || !1),
                ...
                if (e) {
                  ...
                  h.is.form() &&
                    ((m = T.attr('action') || R.attr('action') || !1),
                    h.debug(
            ...
            u
              ? (F === i && h.initialize(), h.invoke(c))
              : (F !== i && F.invoke('destroy'), h.initialize());
        }),
        o !== i ? o : this
      );
    }),
                ...
                text: function(e) {
                  ...
                  e && e !== t
                    ? (n.debug('Updating text', e),
                      f.selector.text
                        ? C.data(g.storedText, e)
                            .find(f.selector.text)
                            .text(e)
            ...
            (v = {
              ...
              destroy: function() {
                v.verbose('Destroying previous module'),
                  h && h.disconnect(),
                  p && p.disconnect(),
                  T.off('load' + k, v.event.load).off(
                    'resize' + k,
                    v.event.resize
                  ),
                  R.off('scroll' + k, v.event.scroll).off(
                    'scrollchange' + k,
              ...
              observeChanges: function() {
                'MutationObserver' in t &&
                  ((p = new MutationObserver(v.event.contextChanged)),
                  (h = new MutationObserver(v.event.changed)),
                  p.observe(n, { childList: !0, subtree: !0 }),
                  h.observe(F, { childList: !0, subtree: !0 }),
              ...
              bind: {
                events: function() {
                  v.verbose('Binding visibility events to scroll and resize'),
                    ...
                    R.off('scroll' + k)
                      .on('scroll' + k, v.event.scroll)
                      .on('scrollchange' + k, v.event.scrollchange);
                }
              },
              event: {
                changed: function(e) {
              ...
              should: {
                trackChanges: function() {
                  return d
                    ? (v.debug('One time query, no need to bind events'), !1)
              ...
              checkVisibility: function(e) {
                v.verbose('Checking visibility of element', v.cache.element),
                  !O &&
                    ...
                    v.bottomPassed(),
                    b.onUpdate &&
                      b.onUpdate.call(F, v.get.elementCalculations()));
              },
              passed: function(t, n) {
                ...
                if (t && n) b.onPassed[t] = n;
                  ...
                  o.passing &&
                    e.each(b.onPassed, function(e, t) {
                      o.bottomVisible || o.pixelsPassed > v.get.pixelsPassed(e)
                        ? v.execute(t, e)
                        : b.once || v.remove.occurred(t);
                    });
                }
              },
              onScreen: function(e) {
              ...
              passingReverse: function(e) {
                ...
                if (
                  ...
                  t.passing
                    ? b.once || v.remove.occurred(o)
                    : v.get.occurred('passing') && v.execute(n, o),
                  e !== i)
                )
                  return !t.passing;
              },
              topVisibleReverse: function(e) {
                ...
                if (
                  ...
                  t.topVisible
                    ? b.once || v.remove.occurred(o)
                    : v.get.occurred('topVisible') && v.execute(n, o),
                  e === i)
                )
                  return !t.topVisible;
              },
              bottomVisibleReverse: function(e) {
                ...
                if (
                  ...
                  t.bottomVisible
                    ? b.once || v.remove.occurred(o)
                    : v.get.occurred('bottomVisible') && v.execute(n, o),
                  e === i)
                )
                  return !t.bottomVisible;
              },
              topPassedReverse: function(e) {
                ...
                if (
                  ...
                  t.topPassed
                    ? b.once || v.remove.occurred(o)
                    : v.get.occurred('topPassed') && v.execute(n, o),
                  e === i)
                )
              ...
              bottomPassedReverse: function(e) {
                ...
                if (
                  ...
                  t.bottomPassed
                    ? b.once || v.remove.occurred(o)
                    : v.get.occurred('bottomPassed') && v.execute(n, o),
                  e === i)
                )
                  return !t.bottomPassed;
              },
                  ...
                  e &&
                    (b.continuous
                      ? (v.debug('Callback being called continuously', t, n),
                        e.call(F, n, i))
                      : v.get.occurred(t) ||
                        (v.debug('Conditions met', t, n), e.call(F, n, i))),
                  v.save.occurred(t);
              },
              remove: {
                fixed: function() {
              ...
              save: {
                ...
                screenSize: function() {
                  v.verbose('Saving window position'),
                    (v.cache.screen = { height: R.height() });
                },
                position: function() {
              ...
              get: {
                ...
                direction: function() {
                  return (
                    v.cache.direction === i && v.save.direction(),
                    v.cache.direction
                  );
                },
                elementPosition: function() {
                  return (
                    v.cache.element === i && v.save.elementPosition(),
                    v.cache.element
                  );
                },
                elementCalculations: function() {
                  return (
                    v.cache.element === i && v.save.elementCalculations(),
                    v.cache.element
                  );
                },
                screenCalculations: function() {
                  return (
                    v.cache.screen === i && v.save.screenCalculations(),
                    v.cache.screen
                  );
                },
                screenSize: function() {
                  return (
                    v.cache.screen === i && v.save.screenSize(), v.cache.screen
                  );
                },
                scroll: function() {
                  return (
                    v.cache.scroll === i && v.save.scroll(), v.cache.scroll
                  );
                },
                lastScroll: function() {
                  return v.cache.screen === i
                    ? (v.debug(
              ...
              d
                ? (E === i && v.initialize(),
                  ...
                  E.save.calculations(),
                  v.invoke(u))
                : (E !== i && E.invoke('destroy'), v.initialize());
          }),
          a !== i ? a : this
        );
      }),
