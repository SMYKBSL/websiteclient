            ...
            if ($.isPlainObject(parameters)) {
              ...
              if (isLegacySettings) {
                ...
                if (parameters.fields) {
                  ...
                  if (
                    typeof parameters.fields[ruleKeys[0]] == 'string' ||
  ...
  $.fn.form.settings = {
    ...
    rules: {
      ...
      creditCard: function(cardNumber, cardTypes) {
        ...
        while (length--) {
          sum +=
            producedValue[multiple][parseInt(cardNumber.charAt(length), 10)];
          multiple ^= 1;
        }
      ...
      module = {
        ...
        show: function(callback) {
          ...
          if (module.can.show() && !module.is.active()) {
            ...
            if (
              module.has.message() &&
              !(module.has.maxSelections() || module.has.allResultsFiltered())
            ) {
            ...
            keydown: function(event) {
              ...
              if (isShortcutKey) {
                var $label = $module.find(selector.label),
                  ...
                  caretAtStart =
                    isFocusedOnSearch && module.get.caretPosition() === 0,
                  $nextLabel;
              ...
              var $currentlySelected = $item
                ...
                $visibleItems =
                  $selectedItem.length > 0
                    ? $selectedItem
                        .siblings(':not(.' + className.filtered + ')')
                        .addBack()
        ...
        get: {
          ...
          value: function() {
            var value =
                $input.length > 0 ? $input.val() : $module.data(metadata.value),
              isEmptyMultiselect =
          ...
          choiceText: function($choice, preserveHTML) {
            preserveHTML =
              preserveHTML !== undefined ? preserveHTML : settings.preserveHTML;
            if ($choice) {
          ...
          item: function(value, strict) {
            ...
            if (shouldSearch) {
              $item.each(function() {
                ...
                if (isMultiple) {
                  if (
                    $.inArray(String(optionValue), value) !== -1 ||
        ...
        add: {
          ...
          userSuggestion: function(value) {
            var $addition = $menu.children(selector.addition),
              ...
              alreadyHasValue =
                $existingItem && $existingItem.not(selector.addition).length,
        ...
        remove: {
          ...
          activeLabels: function($activeLabels) {
            $activeLabels =
              $activeLabels ||
              $module.find(selector.label).filter('.' + className.active);
        ...
        has: {
          ...
          label: function(value) {
            var escapedValue = module.escape.value(value),
              $labels = $module.find(selector.label);
            return (
              $labels.filter('[data-value="' + escapedValue + '"]').length > 0
            );
          },
          ...
          allResultsFiltered: function() {
            ...
            return (
              $normalResults.filter(selector.unselectable).length ===
        ...
        is: {
          ...
          alreadySetup: function() {
            return (
              $module.is('select') &&
              $module.parent(selector.dropdown).length > 0 &&
          ...
          onScreen: function($subMenu) {
            ...
            onScreen = {
              ...
              below:
                calculations.context.scrollTop + calculations.context.height >=
                calculations.menu.offset.top + calculations.menu.height
            };
            if (onScreen.below) {
    ...
    $allModules.each(function() {
      ...
      module = {
        ...
        show: function(callback) {
          ...
          if (
            module.is.hidden() &&
            !(module.is.active() && module.is.dropdown())
          ) {
            if (!module.exists()) {
              module.create();
            }
        ...
        set: {
          position: function(position, calculations) {
            ...
            calculations = calculations || module.get.calculations();
            position =
              position || $module.data(metadata.position) || settings.position;
            ...
            switch (position) {
              ...
              case 'top center':
                positioning = {
                  bottom: parent.height - target.top + distanceAway,
                  left:
                    target.left + target.width / 2 - popup.width / 2 + offset,
                  top: 'auto',
                  right: 'auto'
                };
                break;
              ...
              case 'left center':
                positioning = {
                  top:
                    target.top + target.height / 2 - popup.height / 2 + offset,
            ...
            distanceFromBoundary = module.get.distanceFromBoundary(
              popupOffset,
              calculations
            );
        ...
        bind: {
          events: function() {
            ...
            if (module.get.startEvent()) {
              $module
                .on(
                  module.get.startEvent() + eventNamespace,
                  module.event.start
                )
          ...
          close: function() {
            if (
              ...
              $scrollContext.one(
                module.get.scrollEvent() + elementNamespace,
        ...
        is: {
          ...
          svg: function(element) {
            return (
              module.supports.svg() && element instanceof SVGGraphicsElement
            );
          },
          active: function() {
            return $module.hasClass(className.active);
      ...
      module = {
        ...
        get: {
          text: function(templateText) {
            ...
            module.verbose(
              'Adding variables to progress bar text',
              templateText
            );
            return templateText;
          },
          ...
          displayPercent: function() {
            ...
            return settings.precision > 0
              ? Math.round(displayPercent * (10 * settings.precision)) /
        ...
        set: {
          ...
          percent: function(percent) {
            percent =
              typeof percent == 'string' ? +percent.replace('%', '') : percent;
            // round display percentage
            percent =
              settings.precision > 0
                ? Math.round(percent * (10 * settings.precision)) /
                  (10 * settings.precision)
                : Math.round(percent);
            ...
            if (!module.has.total()) {
              module.value =
                settings.precision > 0
                  ? Math.round(
                      (percent / 100) * module.total * (10 * settings.precision)
                    ) /
                    (10 * settings.precision)
      ...
      module = {
        ...
        get: {
          transform: {
            ...
            left: function() {
              var translate = {
                x: -(
                  ($activeSide.outerWidth(true) - $nextSide.outerWidth(true)) /
                  2
                ),
        ...
        stage: {
          above: function() {
            var box = {
              origin:
                ($activeSide.outerHeight(true) - $nextSide.outerHeight(true)) /
                2,
              depth: {
    ...
    $allModules.each(function() {
      ...
      module = {
        ...
        add: {
          defaults: function() {
            var userStates =
              parameters && $.isPlainObject(parameters.states)
                ? parameters.states
                : {};
